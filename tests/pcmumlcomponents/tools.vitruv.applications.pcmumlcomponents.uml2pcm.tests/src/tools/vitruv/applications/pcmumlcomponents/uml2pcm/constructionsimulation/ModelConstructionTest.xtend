...
import tools.vitruv.applications.pcmumlcomponents.uml2pcm.AbstractUmlPcmTest
...
class ModelConstructionTest extends AbstractUmlPcmTest {
	...
	protected def loadModel(String path) {
		...
		return resourceSet.getResource(
			URI.createURI("platform:/plugin/tools.vitruv.applications.pcmumlcomponents.uml2pcm.tests/" + path), true)
	}
}
