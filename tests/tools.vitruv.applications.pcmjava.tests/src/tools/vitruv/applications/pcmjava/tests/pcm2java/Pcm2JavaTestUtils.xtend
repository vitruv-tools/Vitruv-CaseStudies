...
class Pcm2JavaTestUtils {
	...
	public static final String REPOSITORY_NAME_FIRST_LETTER_UPPERCASE = "TestRepository"
	...
	public static final String OPERATION_SIGNATURE_NAME = "TestOperationSignature";
	public static final String PARAMETER_NAME = "testParameterName";

	public static final String SYSTEM_NAME = "TestSystem";
	public static final String SYSTEM_NAMESPACE = "testSystem";
