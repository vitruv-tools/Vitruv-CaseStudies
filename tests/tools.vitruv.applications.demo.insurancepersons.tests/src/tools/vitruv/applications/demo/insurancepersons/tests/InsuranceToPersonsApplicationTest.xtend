...
import tools.vitruv.dsls.demo.insurancepersons.tests.InsuranceToPersonsTest

class InsuranceToPersonsApplicationTest extends InsuranceToPersonsTest implements VirtualModelBasedTestView {
