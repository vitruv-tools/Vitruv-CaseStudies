...
class PackageMappingTransformationTest extends Java2PcmTransformationTest {
	...
	void testAddFirstPackage() throws Exception {
		...
		validatePcmView(view -> {
			...
			assertEquals(Pcm2JavaTestUtils.REPOSITORY_NAME_EXPECTED, repository.getEntityName(), "repository has wrong name");
		});
	}
	...
	void testRenameRepository() throws Exception {
		...
		String changedPackageName = Pcm2JavaTestUtils.BASIC_COMPONENT_NAME + Pcm2JavaTestUtils.RENAME;
