...
public class PcmParameterMappingTransformationTest extends Pcm2JavaTransformationTest {
	...
	public void testChangeParameterType() throws Throwable {
		...
		final Repository repo = param.getOperationSignature__Parameter().getInterface__OperationSignature()
	...
	public void testAddMultipleParameters() throws Throwable {
		...
		final OperationSignature opSig = param.getOperationSignature__Parameter();
		final CompositeDataType cdt = super.createAndSyncCompositeDataType(
				opSig.getInterface__OperationSignature().getRepository__Interface(),
	...
	/**
	 * assert that the parameter type has a correspondence to the type of the
	 * parameter in the JaMoPP model
	 */
