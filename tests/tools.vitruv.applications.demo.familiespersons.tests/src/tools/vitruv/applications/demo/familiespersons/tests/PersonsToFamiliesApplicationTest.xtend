...
import tools.vitruv.dsls.demo.familiespersons.tests.PersonsToFamiliesTest

class PersonsToFamiliesApplicationTest extends PersonsToFamiliesTest implements VirtualModelBasedTestView {
