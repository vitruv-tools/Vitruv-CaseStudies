...
import tools.vitruv.dsls.demo.familiespersons.tests.FamiliesToPersonsTest

class FamiliesToPersonsApplicationTest extends FamiliesToPersonsTest implements VirtualModelBasedTestView {
