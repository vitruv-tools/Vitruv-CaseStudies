...
class PcmMediaStoreTestModels extends PcmTestModelsBase implements MediaStoreTest.DomainModels {
	...
	// private static val PCM_MEDIA_STORE_REPOSITORY_PATH = 'src/test/resources/model/pcm/MediaStore.repository'
	static val PCM_MEDIA_STORE_REPOSITORY_PATH = 'src/test/resources/model/pcm/MediaStore_NoSEFF.repository'
