...
public class AddedDataClassTypeOperationReaction extends AbstractReactionRealization {
  ...
  public AddedDataClassTypeOperationReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.class2comp.AddedDataClassTypeOperationReaction.ActionUserExecution userExecution = new mir.reactions.class2comp.AddedDataClassTypeOperationReaction.ActionUserExecution(this.executionState, this);
