...
public class DeletedDataTypeClassPropertyReaction extends AbstractReactionRealization {
  ...
  public DeletedDataTypeClassPropertyReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.class2comp.DeletedDataTypeClassPropertyReaction.ActionUserExecution userExecution = new mir.reactions.class2comp.DeletedDataTypeClassPropertyReaction.ActionUserExecution(this.executionState, this);
