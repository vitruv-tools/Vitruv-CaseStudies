...
public class DeletedDataTypeClassOperationReaction extends AbstractReactionRealization {
  ...
  public DeletedDataTypeClassOperationReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.class2comp.DeletedDataTypeClassOperationReaction.ActionUserExecution userExecution = new mir.reactions.class2comp.DeletedDataTypeClassOperationReaction.ActionUserExecution(this.executionState, this);
