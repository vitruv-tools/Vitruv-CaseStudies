...
public class DeletedClassReaction extends AbstractReactionRealization {
  ...
  public DeletedClassReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.class2comp.DeletedClassReaction.ActionUserExecution userExecution = new mir.reactions.class2comp.DeletedClassReaction.ActionUserExecution(this.executionState, this);
