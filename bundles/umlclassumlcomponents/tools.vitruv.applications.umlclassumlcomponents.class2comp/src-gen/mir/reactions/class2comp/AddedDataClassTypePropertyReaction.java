...
public class AddedDataClassTypePropertyReaction extends AbstractReactionRealization {
  ...
  public AddedDataClassTypePropertyReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.class2comp.AddedDataClassTypePropertyReaction.ActionUserExecution userExecution = new mir.reactions.class2comp.AddedDataClassTypePropertyReaction.ActionUserExecution(this.executionState, this);
