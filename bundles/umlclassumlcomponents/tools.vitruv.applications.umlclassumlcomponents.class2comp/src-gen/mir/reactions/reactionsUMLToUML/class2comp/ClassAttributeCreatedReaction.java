...
class ClassAttributeCreatedReaction extends AbstractReactionRealization {
  public ClassAttributeCreatedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLToUML.class2comp.ClassAttributeCreatedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLToUML.class2comp.ClassAttributeCreatedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final org.eclipse.uml2.uml.Class affectedEObject, final EReference affectedFeature, final Property newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.createCompAttribute(affectedEObject, newValue);
    }
  }
}
