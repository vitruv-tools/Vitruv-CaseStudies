...
public class RoutinesFacade extends AbstractRepairRoutinesFacade {
  ...
  public boolean createModelSelfCorrespondence(final Model umlCompModel) {
    mir.routines.class2comp.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(tools.vitruv.extensions.dslsruntime.reactions.structure.ReactionsImportPath.fromPathString("class2comp").prepend(this._getParentImportPath()));
