...
public class ChangeCorrespondingVisibilityRoutine extends AbstractRepairRoutineRealization {
  ...
  public ChangeCorrespondingVisibilityRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final NamedElement classElement) {
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    userExecution.callRoutine1(classElement, this.getRoutinesFacade());
