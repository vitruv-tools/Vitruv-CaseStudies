...
public class CreatedDatatypeReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.comp2class.CreatedDatatypeReaction.ActionUserExecution userExecution = new mir.reactions.comp2class.CreatedDatatypeReaction.ActionUserExecution(this.executionState, this);
