...
public class ElementVisibilityChangedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.comp2class.ElementVisibilityChangedReaction.ActionUserExecution userExecution = new mir.reactions.comp2class.ElementVisibilityChangedReaction.ActionUserExecution(this.executionState, this);
