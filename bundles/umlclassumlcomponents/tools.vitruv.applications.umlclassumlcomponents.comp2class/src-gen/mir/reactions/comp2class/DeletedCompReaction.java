...
public class DeletedCompReaction extends AbstractReactionRealization {
  ...
  public DeletedCompReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.comp2class.DeletedCompReaction.ActionUserExecution userExecution = new mir.reactions.comp2class.DeletedCompReaction.ActionUserExecution(this.executionState, this);
