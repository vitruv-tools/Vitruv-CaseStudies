...
public class RenamedElementReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.comp2class.RenamedElementReaction.ActionUserExecution userExecution = new mir.reactions.comp2class.RenamedElementReaction.ActionUserExecution(this.executionState, this);
