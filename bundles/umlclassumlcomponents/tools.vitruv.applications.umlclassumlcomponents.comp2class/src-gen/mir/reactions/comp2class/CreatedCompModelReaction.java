...
public class CreatedCompModelReaction extends AbstractReactionRealization {
  ...
  public CreatedCompModelReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.comp2class.CreatedCompModelReaction.ActionUserExecution userExecution = new mir.reactions.comp2class.CreatedCompModelReaction.ActionUserExecution(this.executionState, this);
