...
class CreatedUmlComponentReaction extends AbstractReactionRealization {
  public CreatedUmlComponentReaction(final UserInteracting userInteracting) {
    super(userInteracting);
  }
  
  public void executeReaction(final EChange change) {
    InsertEReference<Model, Component> typedChange = ((CreateAndInsertNonRoot<Model, Component>)change).getInsertChange();
  ...
  private boolean checkChangeProperties(final EChange change) {
    InsertEReference<Model, Component> relevantChange = ((CreateAndInsertNonRoot<Model, Component>)change).getInsertChange();
