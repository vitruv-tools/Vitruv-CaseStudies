...
class RemovedInterfaceRealizationReaction extends AbstractReactionRealization {
  public RemovedInterfaceRealizationReaction(final UserInteracting userInteracting) {
    super(userInteracting);
  }
  
  public void executeReaction(final EChange change) {
    RemoveEReference<Component, InterfaceRealization> typedChange = ((RemoveAndDeleteNonRoot<Component, InterfaceRealization>)change).getRemoveChange();
  ...
  private boolean checkChangeProperties(final EChange change) {
    RemoveEReference<Component, InterfaceRealization> relevantChange = ((RemoveAndDeleteNonRoot<Component, InterfaceRealization>)change).getRemoveChange();
