...
public class CreateDataTypeForDataTypeRoutine extends AbstractRepairRoutineRealization {
  ...
  public CreateDataTypeForDataTypeRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final DataType compType) {
