...
public class RenameClassModelForComponentModelRoutine extends AbstractRepairRoutineRealization {
  ...
  public RenameClassModelForComponentModelRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Model compModel) {
