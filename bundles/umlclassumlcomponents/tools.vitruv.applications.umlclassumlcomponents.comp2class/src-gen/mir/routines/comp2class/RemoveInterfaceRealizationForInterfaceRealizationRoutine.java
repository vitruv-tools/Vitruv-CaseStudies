...
public class RemoveInterfaceRealizationForInterfaceRealizationRoutine extends AbstractRepairRoutineRealization {
  ...
  public RemoveInterfaceRealizationForInterfaceRealizationRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final InterfaceRealization compIFRealization) {
