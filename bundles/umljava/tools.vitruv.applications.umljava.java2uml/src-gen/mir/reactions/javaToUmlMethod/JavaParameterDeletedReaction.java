...
public class JavaParameterDeletedReaction extends AbstractReactionRealization {
  ...
  public JavaParameterDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.javaToUmlMethod.JavaParameterDeletedReaction.ActionUserExecution userExecution = new mir.reactions.javaToUmlMethod.JavaParameterDeletedReaction.ActionUserExecution(this.executionState, this);
