...
public class JavaMethodMadeNonAbstractReaction extends AbstractReactionRealization {
  private RemoveEReference<ClassMethod, Abstract> removeChange;
  
  private DeleteEObject<Abstract> deleteChange;
  
  private int currentlyMatchedChange;
  
  public JavaMethodMadeNonAbstractReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.javaToUmlMethod.JavaMethodMadeNonAbstractReaction.ActionUserExecution userExecution = new mir.reactions.javaToUmlMethod.JavaMethodMadeNonAbstractReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean matchRemoveChange(final EChange change) {
    if (change instanceof RemoveEReference<?, ?>) {
    	RemoveEReference<org.emftext.language.java.members.ClassMethod, org.emftext.language.java.modifiers.Abstract> _localTypedChange = (RemoveEReference<org.emftext.language.java.members.ClassMethod, org.emftext.language.java.modifiers.Abstract>) change;
    	...
    	this.removeChange = (RemoveEReference<org.emftext.language.java.members.ClassMethod, org.emftext.language.java.modifiers.Abstract>) change;
    	return true;
    }
