...
public class JavaMethodMadeNonFinalReaction extends AbstractReactionRealization {
  ...
  public JavaMethodMadeNonFinalReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.javaToUmlMethod.JavaMethodMadeNonFinalReaction.ActionUserExecution userExecution = new mir.reactions.javaToUmlMethod.JavaMethodMadeNonFinalReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final ClassMethod affectedEObject, final EReference affectedFeature, final Final oldValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
