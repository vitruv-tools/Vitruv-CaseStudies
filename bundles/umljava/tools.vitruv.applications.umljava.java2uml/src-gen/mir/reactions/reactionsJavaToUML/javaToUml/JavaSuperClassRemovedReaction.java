...
class JavaSuperClassRemovedReaction extends AbstractReactionRealization {
  public JavaSuperClassRemovedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsJavaToUML.javaToUml.JavaSuperClassRemovedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUML.javaToUml.JavaSuperClassRemovedReaction.ActionUserExecution(this.executionState, this);
