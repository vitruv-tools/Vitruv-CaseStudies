...
class JavaParameterDeletedReaction extends AbstractReactionRealization {
  public JavaParameterDeletedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsJavaToUML.javaToUml.JavaParameterDeletedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUML.javaToUml.JavaParameterDeletedReaction.ActionUserExecution(this.executionState, this);
