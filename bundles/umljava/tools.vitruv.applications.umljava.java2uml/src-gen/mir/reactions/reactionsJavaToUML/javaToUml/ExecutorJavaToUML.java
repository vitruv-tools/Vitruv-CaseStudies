...
public class ExecutorJavaToUML extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(mir.reactions.reactionsJavaToUML.javaToUml.JavaClassMadePublicReaction.getExpectedChangeType(), new mir.reactions.reactionsJavaToUML.javaToUml.JavaClassMadePublicReaction(userInteracting));
    ...
    this.addReaction(mir.reactions.reactionsJavaToUML.javaToUml.JavaMethodCreatedReaction.getExpectedChangeType(), new mir.reactions.reactionsJavaToUML.javaToUml.JavaMethodCreatedReaction(userInteracting));
    ...
    this.addReaction(mir.reactions.reactionsJavaToUML.javaToUml.JavaMethodMadePublicReaction.getExpectedChangeType(), new mir.reactions.reactionsJavaToUML.javaToUml.JavaMethodMadePublicReaction(userInteracting));
    ...
    this.addReaction(mir.reactions.reactionsJavaToUML.javaToUml.JavaAttributeMadePublicReaction.getExpectedChangeType(), new mir.reactions.reactionsJavaToUML.javaToUml.JavaAttributeMadePublicReaction(userInteracting));
