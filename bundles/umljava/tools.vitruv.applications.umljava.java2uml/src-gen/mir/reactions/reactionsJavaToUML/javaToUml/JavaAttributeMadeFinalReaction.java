...
class JavaAttributeMadeFinalReaction extends AbstractReactionRealization {
  public JavaAttributeMadeFinalReaction(final UserInteracting userInteracting) {
    super(userInteracting);
  }
  
  public void executeReaction(final EChange change) {
    InsertEReference<Field, Final> typedChange = ((CreateAndInsertNonRoot<Field, Final>)change).getInsertChange();
    ...
    mir.reactions.reactionsJavaToUML.javaToUml.JavaAttributeMadeFinalReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUML.javaToUml.JavaAttributeMadeFinalReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkChangeProperties(final EChange change) {
    InsertEReference<Field, Final> relevantChange = ((CreateAndInsertNonRoot<Field, Final>)change).getInsertChange();
