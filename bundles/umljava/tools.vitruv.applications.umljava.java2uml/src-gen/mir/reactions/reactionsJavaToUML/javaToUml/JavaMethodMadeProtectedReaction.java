...
class JavaMethodMadeProtectedReaction extends AbstractReactionRealization {
  public JavaMethodMadeProtectedReaction(final UserInteracting userInteracting) {
    super(userInteracting);
  }
  
  public void executeReaction(final EChange change) {
    InsertEReference<ClassMethod, Protected> typedChange = ((CreateAndInsertNonRoot<ClassMethod, Protected>)change).getInsertChange();
    ...
    mir.reactions.reactionsJavaToUML.javaToUml.JavaMethodMadeProtectedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUML.javaToUml.JavaMethodMadeProtectedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkChangeProperties(final EChange change) {
    InsertEReference<ClassMethod, Protected> relevantChange = ((CreateAndInsertNonRoot<ClassMethod, Protected>)change).getInsertChange();
