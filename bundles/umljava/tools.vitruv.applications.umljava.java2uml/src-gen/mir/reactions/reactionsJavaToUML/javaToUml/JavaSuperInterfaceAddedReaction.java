...
class JavaSuperInterfaceAddedReaction extends AbstractReactionRealization {
  public JavaSuperInterfaceAddedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsJavaToUML.javaToUml.JavaSuperInterfaceAddedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUML.javaToUml.JavaSuperInterfaceAddedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Interface affectedEObject, final EReference affectedFeature, final TypeReference newValue, @Extension final RoutinesFacade _routinesFacade) {
      ...
      _routinesFacade.addUmlSuperClassifier(affectedEObject, _classifierfromTypeRef);
    }
  }
}
