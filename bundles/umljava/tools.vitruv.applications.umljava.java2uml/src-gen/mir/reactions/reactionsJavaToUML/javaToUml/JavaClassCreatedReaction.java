...
class JavaClassCreatedReaction extends AbstractReactionRealization {
  public JavaClassCreatedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsJavaToUML.javaToUml.JavaClassCreatedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUML.javaToUml.JavaClassCreatedReaction.ActionUserExecution(this.executionState, this);
