...
class JavaParameterTypeChangedReaction extends AbstractReactionRealization {
  public JavaParameterTypeChangedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsJavaToUML.javaToUml.JavaParameterTypeChangedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUML.javaToUml.JavaParameterTypeChangedReaction.ActionUserExecution(this.executionState, this);
