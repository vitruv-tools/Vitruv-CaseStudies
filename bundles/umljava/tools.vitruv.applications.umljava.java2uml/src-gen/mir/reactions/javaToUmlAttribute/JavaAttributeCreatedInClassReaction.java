...
public class JavaAttributeCreatedInClassReaction extends AbstractReactionRealization {
  ...
  public JavaAttributeCreatedInClassReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.javaToUmlAttribute.JavaAttributeCreatedInClassReaction.ActionUserExecution userExecution = new mir.reactions.javaToUmlAttribute.JavaAttributeCreatedInClassReaction.ActionUserExecution(this.executionState, this);
