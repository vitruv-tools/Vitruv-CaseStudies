...
class JavaElementVisibilityChangedReaction extends AbstractReactionRealization {
  public JavaElementVisibilityChangedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsJavaToUml.javaToUmlClassifier.JavaElementVisibilityChangedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUml.javaToUmlClassifier.JavaElementVisibilityChangedReaction.ActionUserExecution(this.executionState, this);
