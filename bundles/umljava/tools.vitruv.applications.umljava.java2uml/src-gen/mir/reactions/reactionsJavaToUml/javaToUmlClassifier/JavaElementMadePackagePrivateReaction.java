...
class JavaElementMadePackagePrivateReaction extends AbstractReactionRealization {
  public JavaElementMadePackagePrivateReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsJavaToUml.javaToUmlClassifier.JavaElementMadePackagePrivateReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUml.javaToUmlClassifier.JavaElementMadePackagePrivateReaction.ActionUserExecution(this.executionState, this);
