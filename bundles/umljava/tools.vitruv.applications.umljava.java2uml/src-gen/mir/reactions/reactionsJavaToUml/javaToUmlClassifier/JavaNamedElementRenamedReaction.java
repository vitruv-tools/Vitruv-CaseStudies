...
class JavaNamedElementRenamedReaction extends AbstractReactionRealization {
  public JavaNamedElementRenamedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsJavaToUml.javaToUmlClassifier.JavaNamedElementRenamedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsJavaToUml.javaToUmlClassifier.JavaNamedElementRenamedReaction.ActionUserExecution(this.executionState, this);
