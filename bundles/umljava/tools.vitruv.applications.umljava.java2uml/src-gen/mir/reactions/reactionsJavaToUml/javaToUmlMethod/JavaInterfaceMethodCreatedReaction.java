...
public class JavaInterfaceMethodCreatedReaction extends AbstractReactionRealization {
  private CreateEObject<InterfaceMethod> createChange;
  
  private InsertEReference<Interface, InterfaceMethod> insertChange;
  
  private int currentlyMatchedChange;
  
  public JavaInterfaceMethodCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  private boolean matchCreateChange(final EChange change) {
    if (change instanceof CreateEObject<?>) {
    	CreateEObject<org.emftext.language.java.members.InterfaceMethod> _localTypedChange = (CreateEObject<org.emftext.language.java.members.InterfaceMethod>) change;
    	if (!(_localTypedChange.getAffectedEObject() instanceof org.emftext.language.java.members.InterfaceMethod)) {
    		return false;
    	}
    	this.createChange = (CreateEObject<org.emftext.language.java.members.InterfaceMethod>) change;
    	return true;
    }
