...
public class JavaSuperClassRemovedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<org.emftext.language.java.classifiers.Class, TypeReference> replaceChange;
  
  private int currentlyMatchedChange;
  
  public JavaSuperClassRemovedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.javaToUmlClassifier.JavaSuperClassRemovedReaction.ActionUserExecution userExecution = new mir.reactions.javaToUmlClassifier.JavaSuperClassRemovedReaction.ActionUserExecution(this.executionState, this);
