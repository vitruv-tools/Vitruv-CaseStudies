...
public class JavaEnumConstantCreatedReaction extends AbstractReactionRealization {
  ...
  public JavaEnumConstantCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.javaToUmlClassifier.JavaEnumConstantCreatedReaction.ActionUserExecution userExecution = new mir.reactions.javaToUmlClassifier.JavaEnumConstantCreatedReaction.ActionUserExecution(this.executionState, this);
