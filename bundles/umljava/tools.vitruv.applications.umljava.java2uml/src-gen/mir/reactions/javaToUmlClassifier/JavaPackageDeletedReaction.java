...
public class JavaPackageDeletedReaction extends AbstractReactionRealization {
  ...
  public JavaPackageDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.javaToUmlClassifier.JavaPackageDeletedReaction.ActionUserExecution userExecution = new mir.reactions.javaToUmlClassifier.JavaPackageDeletedReaction.ActionUserExecution(this.executionState, this);
