...
public class UmlMethodMadeAbstractReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Operation, Boolean> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlMethodMadeAbstractReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlMethodMadeAbstractReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlMethodMadeAbstractReaction.ActionUserExecution(this.executionState, this);
