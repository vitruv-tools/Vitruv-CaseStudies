...
public class UmlParameterDirectionChangedFromReturnReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Parameter, ParameterDirectionKind> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlParameterDirectionChangedFromReturnReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedFromReturnReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedFromReturnReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkUserDefinedPrecondition(final ReplaceSingleValuedEAttribute replaceChange, final Parameter affectedEObject, final EAttribute affectedFeature, final ParameterDirectionKind oldValue, final ParameterDirectionKind newValue) {
    boolean _equals = Objects.equal(oldValue, ParameterDirectionKind.RETURN_LITERAL);
    return _equals;
  }
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Parameter affectedEObject, final EAttribute affectedFeature, final ParameterDirectionKind oldValue, final ParameterDirectionKind newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.adaptParameterDirectionChangedFromReturn(affectedEObject.getOperation());
    }
  }
}
