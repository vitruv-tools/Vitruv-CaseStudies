...
public class UmlMethodCreatedReaction extends AbstractReactionRealization {
  ...
  public UmlMethodCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlMethodCreatedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlMethodCreatedReaction.ActionUserExecution(this.executionState, this);
