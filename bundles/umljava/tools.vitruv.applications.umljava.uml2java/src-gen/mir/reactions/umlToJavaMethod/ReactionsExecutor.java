...
class ReactionsExecutor extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(new mir.reactions.umlToJavaMethod.RegularOrReturnParameterUpperChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaMethod"))));
    this.addReaction(new mir.reactions.umlToJavaMethod.RegularOrReturnParameterLowerChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaMethod"))));
    this.addReaction(new mir.reactions.umlToJavaMethod.RegularOrReturnParameterUnlimitedBoundChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaMethod"))));
    this.addReaction(new mir.reactions.umlToJavaMethod.RegularOrReturnParameterIntegerBoundChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaMethod"))));
