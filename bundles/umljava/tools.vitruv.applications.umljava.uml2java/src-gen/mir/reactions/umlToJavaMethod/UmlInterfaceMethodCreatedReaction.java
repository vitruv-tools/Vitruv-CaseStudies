...
public class UmlInterfaceMethodCreatedReaction extends AbstractReactionRealization {
  ...
  public UmlInterfaceMethodCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlInterfaceMethodCreatedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlInterfaceMethodCreatedReaction.ActionUserExecution(this.executionState, this);
