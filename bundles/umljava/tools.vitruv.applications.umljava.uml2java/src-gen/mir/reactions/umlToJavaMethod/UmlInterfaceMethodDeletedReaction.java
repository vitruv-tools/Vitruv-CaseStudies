...
public class UmlInterfaceMethodDeletedReaction extends AbstractReactionRealization {
  ...
  public UmlInterfaceMethodDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlInterfaceMethodDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlInterfaceMethodDeletedReaction.ActionUserExecution(this.executionState, this);
