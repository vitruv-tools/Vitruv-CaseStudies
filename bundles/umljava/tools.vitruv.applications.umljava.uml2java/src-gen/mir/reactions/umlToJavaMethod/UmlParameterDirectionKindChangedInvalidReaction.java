...
public class UmlParameterDirectionKindChangedInvalidReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Parameter, ParameterDirectionKind> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlParameterDirectionKindChangedInvalidReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlParameterDirectionKindChangedInvalidReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlParameterDirectionKindChangedInvalidReaction.ActionUserExecution(this.executionState, this);
