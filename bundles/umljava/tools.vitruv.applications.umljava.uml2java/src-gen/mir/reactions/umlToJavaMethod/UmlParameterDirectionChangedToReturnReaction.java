...
public class UmlParameterDirectionChangedToReturnReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Parameter, ParameterDirectionKind> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlParameterDirectionChangedToReturnReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedToReturnReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedToReturnReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Parameter affectedEObject, final EAttribute affectedFeature, final ParameterDirectionKind oldValue, final ParameterDirectionKind newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.adaptParameterDirectionChangedToReturn(affectedEObject.getOperation(), affectedEObject);
    }
  }
}
