...
public class UmlClassMethodDeletedReaction extends AbstractReactionRealization {
  ...
  public UmlClassMethodDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlClassMethodDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlClassMethodDeletedReaction.ActionUserExecution(this.executionState, this);
