...
public class UmlMethodMadeFinalReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Operation, Boolean> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlMethodMadeFinalReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.UmlMethodMadeFinalReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.UmlMethodMadeFinalReaction.ActionUserExecution(this.executionState, this);
