...
public class RegularOrReturnParameterIntegerBoundChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<LiteralInteger, Integer> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RegularOrReturnParameterIntegerBoundChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaMethod.RegularOrReturnParameterIntegerBoundChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaMethod.RegularOrReturnParameterIntegerBoundChangedReaction.ActionUserExecution(this.executionState, this);
