...
public class UmlSuperInterfaceAddedReaction extends AbstractReactionRealization {
  private InsertEReference<Interface, Generalization> insertChange;
  
  private int currentlyMatchedChange;
  
  public UmlSuperInterfaceAddedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlSuperInterfaceAddedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlSuperInterfaceAddedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final Interface affectedEObject, final EReference affectedFeature, final Generalization newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.addJavaSuperInterface(affectedEObject, newValue);
    }
  }
}
