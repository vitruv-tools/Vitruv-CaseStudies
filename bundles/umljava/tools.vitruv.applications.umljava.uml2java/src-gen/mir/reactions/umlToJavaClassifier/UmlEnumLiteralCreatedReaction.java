...
public class UmlEnumLiteralCreatedReaction extends AbstractReactionRealization {
  ...
  public UmlEnumLiteralCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlEnumLiteralCreatedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlEnumLiteralCreatedReaction.ActionUserExecution(this.executionState, this);
