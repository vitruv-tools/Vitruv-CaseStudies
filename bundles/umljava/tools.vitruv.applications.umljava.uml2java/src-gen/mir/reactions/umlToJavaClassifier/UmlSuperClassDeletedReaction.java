...
public class UmlSuperClassDeletedReaction extends AbstractReactionRealization {
  ...
  public UmlSuperClassDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlSuperClassDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlSuperClassDeletedReaction.ActionUserExecution(this.executionState, this);
