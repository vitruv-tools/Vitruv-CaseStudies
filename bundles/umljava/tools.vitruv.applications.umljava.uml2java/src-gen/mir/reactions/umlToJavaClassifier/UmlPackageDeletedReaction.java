...
public class UmlPackageDeletedReaction extends AbstractReactionRealization {
  ...
  public UmlPackageDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlPackageDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlPackageDeletedReaction.ActionUserExecution(this.executionState, this);
