...
public class UmlEnumCreatedReaction extends AbstractReactionRealization {
  ...
  public UmlEnumCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlEnumCreatedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlEnumCreatedReaction.ActionUserExecution(this.executionState, this);
