...
public class UmlPackageRenamedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<org.eclipse.uml2.uml.Package, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlPackageRenamedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlPackageRenamedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlPackageRenamedReaction.ActionUserExecution(this.executionState, this);
