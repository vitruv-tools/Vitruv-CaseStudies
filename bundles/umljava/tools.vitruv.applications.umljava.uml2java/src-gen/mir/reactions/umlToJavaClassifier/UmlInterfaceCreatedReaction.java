...
public class UmlInterfaceCreatedReaction extends AbstractReactionRealization {
  ...
  public UmlInterfaceCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlInterfaceCreatedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlInterfaceCreatedReaction.ActionUserExecution(this.executionState, this);
