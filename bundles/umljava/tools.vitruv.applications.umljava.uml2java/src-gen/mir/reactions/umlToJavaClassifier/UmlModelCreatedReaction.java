...
public class UmlModelCreatedReaction extends AbstractReactionRealization {
  ...
  public UmlModelCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlModelCreatedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlModelCreatedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertRootEObject insertChange, final Model newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.checkIfUmlModelCorrespondenceExists(newValue);
    }
  }
}
