...
public class UmlInterfaceImplementerChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<InterfaceRealization, org.eclipse.uml2.uml.Class> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlInterfaceImplementerChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlInterfaceImplementerChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlInterfaceImplementerChangedReaction.ActionUserExecution(this.executionState, this);
