...
public class UmlClassCreatedReaction extends AbstractReactionRealization {
  ...
  public UmlClassCreatedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaClassifier.UmlClassCreatedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaClassifier.UmlClassCreatedReaction.ActionUserExecution(this.executionState, this);
