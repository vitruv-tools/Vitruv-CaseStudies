...
class ReactionsExecutor extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(new mir.reactions.umlToJavaClassifier.UmlSuperClassChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaClassifier"))));
    ...
    this.addReaction(new mir.reactions.umlToJavaClassifier.UmlInterfaceImplementerChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaClassifier"))));
    this.addReaction(new mir.reactions.umlToJavaClassifier.UmlImplementedInterfaceChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaClassifier"))));
    this.addReaction(new mir.reactions.umlToJavaClassifier.UmlImplementedInterfaceDeletedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaClassifier"))));
    ...
    this.addReaction(new mir.reactions.umlToJavaClassifier.UmlSuperInterfaceChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaClassifier"))));
    ...
    this.addReaction(new mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJava.umlToJavaMethod"))));
