...
class UmlMethodMadeAbstractReaction extends AbstractReactionRealization {
  public UmlMethodMadeAbstractReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLToJava.umlToJava.UmlMethodMadeAbstractReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLToJava.umlToJava.UmlMethodMadeAbstractReaction.ActionUserExecution(this.executionState, this);
