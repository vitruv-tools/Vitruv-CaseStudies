...
class UmlFeatureMadeStaticReaction extends AbstractReactionRealization {
  public UmlFeatureMadeStaticReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLToJava.umlToJava.UmlFeatureMadeStaticReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLToJava.umlToJava.UmlFeatureMadeStaticReaction.ActionUserExecution(this.executionState, this);
