...
class UmlParameterRenamedReaction extends AbstractReactionRealization {
  public UmlParameterRenamedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLToJava.umlToJava.UmlParameterRenamedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLToJava.umlToJava.UmlParameterRenamedReaction.ActionUserExecution(this.executionState, this);
