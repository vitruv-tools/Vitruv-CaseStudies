...
class UmlInterfaceImplementCreatedReaction extends AbstractReactionRealization {
  public UmlInterfaceImplementCreatedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLToJava.umlToJava.UmlInterfaceImplementCreatedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLToJava.umlToJava.UmlInterfaceImplementCreatedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InterfaceRealization affectedEObject, final EReference affectedFeature, final Interface newValue, @Extension final RoutinesFacade _routinesFacade) {
      ...
      _routinesFacade.createJavaInterfaceImplement(newValue, ((org.eclipse.uml2.uml.Class) _eContainer));
    }
  }
}
