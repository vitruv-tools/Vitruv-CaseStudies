...
class UmlInterfaceImplementDeletedReaction extends AbstractReactionRealization {
  public UmlInterfaceImplementDeletedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLToJava.umlToJava.UmlInterfaceImplementDeletedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLToJava.umlToJava.UmlInterfaceImplementDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final org.eclipse.uml2.uml.Class affectedEObject, final EReference affectedFeature, final InterfaceRealization oldValue, @Extension final RoutinesFacade _routinesFacade) {
      ...
      _routinesFacade.deleteJavaInterfaceImplement(((Interface) _head), affectedEObject);
    }
  }
}
