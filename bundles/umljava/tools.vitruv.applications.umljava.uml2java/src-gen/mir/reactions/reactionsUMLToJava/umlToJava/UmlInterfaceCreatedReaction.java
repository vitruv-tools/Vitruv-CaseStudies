...
class UmlInterfaceCreatedReaction extends AbstractReactionRealization {
  public UmlInterfaceCreatedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLToJava.umlToJava.UmlInterfaceCreatedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLToJava.umlToJava.UmlInterfaceCreatedReaction.ActionUserExecution(this.executionState, this);
