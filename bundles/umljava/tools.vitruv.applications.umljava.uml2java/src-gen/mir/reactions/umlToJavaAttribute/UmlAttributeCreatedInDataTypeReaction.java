...
public class UmlAttributeCreatedInDataTypeReaction extends AbstractReactionRealization {
  ...
  public UmlAttributeCreatedInDataTypeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaAttribute.UmlAttributeCreatedInDataTypeReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaAttribute.UmlAttributeCreatedInDataTypeReaction.ActionUserExecution(this.executionState, this);
