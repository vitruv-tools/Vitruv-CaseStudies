...
public class UmlAttributeCreatedInInterfaceReaction extends AbstractReactionRealization {
  ...
  public UmlAttributeCreatedInInterfaceReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaAttribute.UmlAttributeCreatedInInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaAttribute.UmlAttributeCreatedInInterfaceReaction.ActionUserExecution(this.executionState, this);
