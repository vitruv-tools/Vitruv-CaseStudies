...
public class UmlAttributeRenamedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Property, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlAttributeRenamedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaAttribute.UmlAttributeRenamedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaAttribute.UmlAttributeRenamedReaction.ActionUserExecution(this.executionState, this);
