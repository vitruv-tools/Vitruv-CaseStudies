...
public class UmlUpperMultiplicityChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<LiteralUnlimitedNatural, Integer> replaceChange;
  
  private int currentlyMatchedChange;
  
  public UmlUpperMultiplicityChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToJavaAttribute.UmlUpperMultiplicityChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlToJavaAttribute.UmlUpperMultiplicityChangedReaction.ActionUserExecution(this.executionState, this);
