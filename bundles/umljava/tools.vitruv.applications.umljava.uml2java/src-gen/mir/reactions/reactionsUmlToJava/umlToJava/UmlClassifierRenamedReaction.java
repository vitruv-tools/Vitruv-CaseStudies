...
class UmlClassifierRenamedReaction extends AbstractReactionRealization {
  public UmlClassifierRenamedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJava.UmlClassifierRenamedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJava.UmlClassifierRenamedReaction.ActionUserExecution(this.executionState, this);
