...
class UmlEnumCreatedReaction extends AbstractReactionRealization {
  public UmlEnumCreatedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJava.UmlEnumCreatedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJava.UmlEnumCreatedReaction.ActionUserExecution(this.executionState, this);
