...
class UmlPackageDeletedReaction extends AbstractReactionRealization {
  public UmlPackageDeletedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJava.UmlPackageDeletedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJava.UmlPackageDeletedReaction.ActionUserExecution(this.executionState, this);
