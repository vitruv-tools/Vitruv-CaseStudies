...
class UmlInterfaceMethodCreatedReaction extends AbstractReactionRealization {
  public UmlInterfaceMethodCreatedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJava.UmlInterfaceMethodCreatedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJava.UmlInterfaceMethodCreatedReaction.ActionUserExecution(this.executionState, this);
