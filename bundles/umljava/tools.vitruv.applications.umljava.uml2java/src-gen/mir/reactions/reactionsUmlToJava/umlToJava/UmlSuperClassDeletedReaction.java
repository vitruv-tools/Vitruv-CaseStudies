...
class UmlSuperClassDeletedReaction extends AbstractReactionRealization {
  public UmlSuperClassDeletedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJava.UmlSuperClassDeletedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJava.UmlSuperClassDeletedReaction.ActionUserExecution(this.executionState, this);
