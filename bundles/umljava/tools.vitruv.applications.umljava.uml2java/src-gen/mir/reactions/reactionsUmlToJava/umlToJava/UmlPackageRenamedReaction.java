...
class UmlPackageRenamedReaction extends AbstractReactionRealization {
  public UmlPackageRenamedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJava.UmlPackageRenamedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJava.UmlPackageRenamedReaction.ActionUserExecution(this.executionState, this);
