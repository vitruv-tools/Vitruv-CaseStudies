...
class UmlMethodReturnTypeRemovedReaction extends AbstractReactionRealization {
  public UmlMethodReturnTypeRemovedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJavaMethod.UmlMethodReturnTypeRemovedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJavaMethod.UmlMethodReturnTypeRemovedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkUserDefinedPrecondition(final Parameter affectedEObject, final EAttribute affectedFeature, final ParameterDirectionKind oldValue, final ParameterDirectionKind newValue) {
    return (Objects.equal(oldValue, ParameterDirectionKind.RETURN_LITERAL) && (!Objects.equal(newValue, ParameterDirectionKind.RETURN_LITERAL)));
  }
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Parameter affectedEObject, final EAttribute affectedFeature, final ParameterDirectionKind oldValue, final ParameterDirectionKind newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.setJavaMethodReturnType(affectedEObject, Integer.valueOf(1));
    }
  }
}
