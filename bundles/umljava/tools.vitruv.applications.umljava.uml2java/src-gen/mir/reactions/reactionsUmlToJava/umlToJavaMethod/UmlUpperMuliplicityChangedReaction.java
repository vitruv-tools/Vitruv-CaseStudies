...
class UmlUpperMuliplicityChangedReaction extends AbstractReactionRealization {
  public UmlUpperMuliplicityChangedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJavaMethod.UmlUpperMuliplicityChangedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJavaMethod.UmlUpperMuliplicityChangedReaction.ActionUserExecution(this.executionState, this);
