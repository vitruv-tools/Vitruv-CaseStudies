...
class UmlLowerMuliplicityChangedReaction extends AbstractReactionRealization {
  public UmlLowerMuliplicityChangedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJavaMethod.UmlLowerMuliplicityChangedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJavaMethod.UmlLowerMuliplicityChangedReaction.ActionUserExecution(this.executionState, this);
