...
class UmlNamedElementRenamedReaction extends AbstractReactionRealization {
  public UmlNamedElementRenamedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJavaClassifier.UmlNamedElementRenamedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJavaClassifier.UmlNamedElementRenamedReaction.ActionUserExecution(this.executionState, this);
