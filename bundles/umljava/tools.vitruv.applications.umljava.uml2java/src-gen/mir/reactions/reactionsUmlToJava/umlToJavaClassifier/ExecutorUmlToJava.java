...
public class ExecutorUmlToJava extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(mir.reactions.reactionsUmlToJava.umlToJavaClassifier.UmlClassifierPackageChangedReaction.getExpectedChangeType(), new mir.reactions.reactionsUmlToJava.umlToJavaClassifier.UmlClassifierPackageChangedReaction(userInteracting));
    ...
    this.addReaction(mir.reactions.reactionsUmlToJava.umlToJavaClassifier.UmlMuliplicityChangedReaction.getExpectedChangeType(), new mir.reactions.reactionsUmlToJava.umlToJavaClassifier.UmlMuliplicityChangedReaction(userInteracting));
  }
}
