...
class UmlAttributeDeletedReaction extends AbstractReactionRealization {
  public UmlAttributeDeletedReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUmlToJava.umlToJavaAttribute.UmlAttributeDeletedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUmlToJava.umlToJavaAttribute.UmlAttributeDeletedReaction.ActionUserExecution(this.executionState, this);
