...
public class SetJavaMethodFinalRoutine extends AbstractRepairRoutineRealization {
  ...
  public SetJavaMethodFinalRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Operation uOperation, final Boolean isFinal) {
