...
public class CheckIfUmlModelCorrespondenceExistsRoutine extends AbstractRepairRoutineRealization {
  private CheckIfUmlModelCorrespondenceExistsRoutine.ActionUserExecution userExecution;
  ...
  public CheckIfUmlModelCorrespondenceExistsRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Model newModel) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlToJavaClassifier.CheckIfUmlModelCorrespondenceExistsRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine CheckIfUmlModelCorrespondenceExistsRoutine with input:");
