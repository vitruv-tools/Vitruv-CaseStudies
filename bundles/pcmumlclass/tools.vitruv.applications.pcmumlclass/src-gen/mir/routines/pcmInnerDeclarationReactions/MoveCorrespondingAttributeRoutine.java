...
public class MoveCorrespondingAttributeRoutine extends AbstractRepairRoutineRealization {
  private MoveCorrespondingAttributeRoutine.ActionUserExecution userExecution;
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void update0Element(final InnerDeclaration pcmAttribute, final CompositeDataType pcmComposite, final org.eclipse.uml2.uml.Class umlComposite, final Property umlAttribute) {
      ...
      _ownedAttributes.add(umlAttribute);
    }
  ...
  public MoveCorrespondingAttributeRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final InnerDeclaration pcmAttribute, final CompositeDataType pcmComposite) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.pcmInnerDeclarationReactions.MoveCorrespondingAttributeRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine MoveCorrespondingAttributeRoutine with input:");
