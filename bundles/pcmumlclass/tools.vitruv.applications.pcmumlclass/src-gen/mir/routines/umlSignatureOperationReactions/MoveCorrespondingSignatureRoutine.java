...
public class MoveCorrespondingSignatureRoutine extends AbstractRepairRoutineRealization {
  private MoveCorrespondingSignatureRoutine.ActionUserExecution userExecution;
  ...
  public MoveCorrespondingSignatureRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Operation umlOperation, final Interface umlInterface) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlSignatureOperationReactions.MoveCorrespondingSignatureRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine MoveCorrespondingSignatureRoutine with input:");
