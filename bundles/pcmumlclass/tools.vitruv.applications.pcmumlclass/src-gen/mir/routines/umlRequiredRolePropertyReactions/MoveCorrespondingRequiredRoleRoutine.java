...
public class MoveCorrespondingRequiredRoleRoutine extends AbstractRepairRoutineRealization {
  private MoveCorrespondingRequiredRoleRoutine.ActionUserExecution userExecution;
  ...
  public MoveCorrespondingRequiredRoleRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Property umlProperty, final org.eclipse.uml2.uml.Class umlComponent) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlRequiredRolePropertyReactions.MoveCorrespondingRequiredRoleRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine MoveCorrespondingRequiredRoleRoutine with input:");
