...
public class MoveCorrespondingInterfaceRoutine extends AbstractRepairRoutineRealization {
  ...
  public MoveCorrespondingInterfaceRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Interface umlInterface, final org.eclipse.uml2.uml.Package umlPackage) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlInterfaceReactions.MoveCorrespondingInterfaceRoutine.ActionUserExecution(getExecutionState(), this);
