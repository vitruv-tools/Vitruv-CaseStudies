...
public class MoveCorrespondingProvidedRoleRoutine extends AbstractRepairRoutineRealization {
  ...
  public MoveCorrespondingProvidedRoleRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final InterfaceRealization umlRealization, final org.eclipse.uml2.uml.Class umlComponent) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlProvidedRoleRealizationReactions.MoveCorrespondingProvidedRoleRoutine.ActionUserExecution(getExecutionState(), this);
