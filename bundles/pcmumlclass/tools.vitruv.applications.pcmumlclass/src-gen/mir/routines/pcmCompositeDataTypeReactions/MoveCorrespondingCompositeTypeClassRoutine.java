...
public class MoveCorrespondingCompositeTypeClassRoutine extends AbstractRepairRoutineRealization {
  private MoveCorrespondingCompositeTypeClassRoutine.ActionUserExecution userExecution;
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void update0Element(final CompositeDataType pcmType, final Repository pcmRepo, final org.eclipse.uml2.uml.Package umlDatatypesPackage, final org.eclipse.uml2.uml.Class umlCompositeClass) {
      ...
      _packagedElements.add(umlCompositeClass);
    }
  ...
  public MoveCorrespondingCompositeTypeClassRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final CompositeDataType pcmType, final Repository pcmRepo) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.pcmCompositeDataTypeReactions.MoveCorrespondingCompositeTypeClassRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine MoveCorrespondingCompositeTypeClassRoutine with input:");
