...
public class CreateUmlContractsPackageRoutine extends AbstractRepairRoutineRealization {
  private CreateUmlContractsPackageRoutine.ActionUserExecution userExecution;
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Repository pcmRepo, final org.eclipse.uml2.uml.Package umlRepositoryPkg, @Extension final RoutinesFacade _routinesFacade) {
      final Function1<org.eclipse.uml2.uml.Package, Boolean> _function = (org.eclipse.uml2.uml.Package pkg) -> {
        ...
        return Boolean.valueOf(Objects.equal(_name, DefaultLiterals.CONTRACTS_PACKAGE_NAME));
      };
      org.eclipse.uml2.uml.Package umlContractsPkg = IterableExtensions.<org.eclipse.uml2.uml.Package>findFirst(umlRepositoryPkg.getNestedPackages(), _function);
      if ((umlContractsPkg == null)) {
        umlContractsPkg = umlRepositoryPkg.createNestedPackage(DefaultLiterals.CONTRACTS_PACKAGE_NAME);
      }
      ReactionsCorrespondenceHelper.addCorrespondence(this.correspondenceModel, pcmRepo, umlContractsPkg, TagLiterals.REPOSITORY_TO_CONTRACTS_PACKAGE);
    }
  }
  
  public CreateUmlContractsPackageRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Repository pcmRepo) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.pcmRepositoryReactions.CreateUmlContractsPackageRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine CreateUmlContractsPackageRoutine with input:");
