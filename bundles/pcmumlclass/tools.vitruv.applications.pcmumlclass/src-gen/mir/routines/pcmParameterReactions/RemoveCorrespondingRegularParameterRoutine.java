...
public class RemoveCorrespondingRegularParameterRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void update0Element(final Parameter pcmParam, final OperationSignature pcmSignature, final Operation umlOperation, final org.eclipse.uml2.uml.Parameter umlParameter) {
      ...
      _ownedParameters.remove(umlParameter);
    }
  ...
  public RemoveCorrespondingRegularParameterRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Parameter pcmParam, final OperationSignature pcmSignature) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.pcmParameterReactions.RemoveCorrespondingRegularParameterRoutine.ActionUserExecution(getExecutionState(), this);
