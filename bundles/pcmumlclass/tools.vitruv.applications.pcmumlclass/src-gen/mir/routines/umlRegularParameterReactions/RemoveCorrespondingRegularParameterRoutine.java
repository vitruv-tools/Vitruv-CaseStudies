...
public class RemoveCorrespondingRegularParameterRoutine extends AbstractRepairRoutineRealization {
  private RemoveCorrespondingRegularParameterRoutine.ActionUserExecution userExecution;
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void update0Element(final Parameter umlParam, final Operation umlOperation, final OperationSignature pcmSignature, final org.palladiosimulator.pcm.repository.Parameter pcmParam) {
      ...
      _parameters__OperationSignature.remove(pcmParam);
    }
  ...
  public RemoveCorrespondingRegularParameterRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Parameter umlParam, final Operation umlOperation) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlRegularParameterReactions.RemoveCorrespondingRegularParameterRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine RemoveCorrespondingRegularParameterRoutine with input:");
