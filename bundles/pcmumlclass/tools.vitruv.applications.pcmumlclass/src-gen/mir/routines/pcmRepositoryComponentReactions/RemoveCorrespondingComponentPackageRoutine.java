...
public class RemoveCorrespondingComponentPackageRoutine extends AbstractRepairRoutineRealization {
  private RemoveCorrespondingComponentPackageRoutine.ActionUserExecution userExecution;
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void update0Element(final RepositoryComponent pcmComponent, final Repository pcmRepository, final org.eclipse.uml2.uml.Package umlRepositoryPackage, final org.eclipse.uml2.uml.Package umlComponentPackage) {
      ...
      _packagedElements.remove(umlComponentPackage);
    }
  ...
  public RemoveCorrespondingComponentPackageRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final RepositoryComponent pcmComponent, final Repository pcmRepository) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.pcmRepositoryComponentReactions.RemoveCorrespondingComponentPackageRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine RemoveCorrespondingComponentPackageRoutine with input:");
