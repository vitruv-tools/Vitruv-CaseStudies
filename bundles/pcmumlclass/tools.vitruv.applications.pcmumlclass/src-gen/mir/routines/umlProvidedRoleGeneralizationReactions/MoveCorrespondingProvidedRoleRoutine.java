...
public class MoveCorrespondingProvidedRoleRoutine extends AbstractRepairRoutineRealization {
  private MoveCorrespondingProvidedRoleRoutine.ActionUserExecution userExecution;
  ...
  public MoveCorrespondingProvidedRoleRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Generalization umlGeneralization, final org.eclipse.uml2.uml.Class umlComponent) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlProvidedRoleGeneralizationReactions.MoveCorrespondingProvidedRoleRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine MoveCorrespondingProvidedRoleRoutine with input:");
