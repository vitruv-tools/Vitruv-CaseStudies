...
public class RemoveCorrespondingAssemblyContextRoutine extends AbstractRepairRoutineRealization {
  private RemoveCorrespondingAssemblyContextRoutine.ActionUserExecution userExecution;
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void update0Element(final Property umlProperty, final org.eclipse.uml2.uml.Class umlComponent, final ComposedProvidingRequiringEntity pcmCompositeComponent, final AssemblyContext pcmAssemblyContext) {
      ...
      _assemblyContexts__ComposedStructure.remove(pcmAssemblyContext);
    }
  ...
  public RemoveCorrespondingAssemblyContextRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Property umlProperty, final org.eclipse.uml2.uml.Class umlComponent) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlAssemblyContextPropertyReactions.RemoveCorrespondingAssemblyContextRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine RemoveCorrespondingAssemblyContextRoutine with input:");
