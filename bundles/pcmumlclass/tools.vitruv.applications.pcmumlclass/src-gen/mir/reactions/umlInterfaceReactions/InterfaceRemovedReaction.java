...
public class InterfaceRemovedReaction extends AbstractReactionRealization {
  private RemoveEReference<org.eclipse.uml2.uml.Package, Interface> removeChange;
  
  private int currentlyMatchedChange;
  
  public InterfaceRemovedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInterfaceReactions.InterfaceRemovedReaction.ActionUserExecution userExecution = new mir.reactions.umlInterfaceReactions.InterfaceRemovedReaction.ActionUserExecution(this.executionState, this);
