...
public class InterfaceInsertedReaction extends AbstractReactionRealization {
  private InsertEReference<org.eclipse.uml2.uml.Package, Interface> insertChange;
  
  private int currentlyMatchedChange;
  
  public InterfaceInsertedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInterfaceReactions.InterfaceInsertedReaction.ActionUserExecution userExecution = new mir.reactions.umlInterfaceReactions.InterfaceInsertedReaction.ActionUserExecution(this.executionState, this);
