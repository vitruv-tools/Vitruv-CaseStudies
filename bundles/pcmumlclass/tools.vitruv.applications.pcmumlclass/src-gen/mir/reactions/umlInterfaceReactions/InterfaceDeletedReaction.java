...
public class InterfaceDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<Interface> deleteChange;
  
  private int currentlyMatchedChange;
  
  public InterfaceDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInterfaceReactions.InterfaceDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlInterfaceReactions.InterfaceDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Interface affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingInterface(affectedEObject);
    }
  }
}
