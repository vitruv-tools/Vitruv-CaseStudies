...
public class InterfaceRenamedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInterfaceReactions.InterfaceRenamedReaction.ActionUserExecution userExecution = new mir.reactions.umlInterfaceReactions.InterfaceRenamedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkUserDefinedPrecondition(final ReplaceSingleValuedEAttribute replaceChange, final Interface affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue) {
