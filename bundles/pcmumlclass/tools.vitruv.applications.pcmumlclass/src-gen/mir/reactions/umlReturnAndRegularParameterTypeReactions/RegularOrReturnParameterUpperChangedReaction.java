...
public class RegularOrReturnParameterUpperChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<Parameter, ValueSpecification> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RegularOrReturnParameterUpperChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlReturnAndRegularParameterTypeReactions.RegularOrReturnParameterUpperChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlReturnAndRegularParameterTypeReactions.RegularOrReturnParameterUpperChangedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean matchReplaceChange(final EChange change) {
    if (change instanceof ReplaceSingleValuedEReference<?, ?>) {
    	...
    	if (!_localTypedChange.getAffectedFeature().getName().equals("upperValue")) {
    		return false;
    	}
