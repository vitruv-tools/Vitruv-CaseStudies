...
public class RegularOrReturnParameterTypeChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<Parameter, Type> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RegularOrReturnParameterTypeChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlReturnAndRegularParameterTypeReactions.RegularOrReturnParameterTypeChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlReturnAndRegularParameterTypeReactions.RegularOrReturnParameterTypeChangedReaction.ActionUserExecution(this.executionState, this);
