...
public class ParameterRenamedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Parameter, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ParameterRenamedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmParameterReactions.ParameterRenamedReaction.ActionUserExecution userExecution = new mir.reactions.pcmParameterReactions.ParameterRenamedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Parameter affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.renameCorrespondingRegularParameter(affectedEObject, newValue);
    }
  }
}
