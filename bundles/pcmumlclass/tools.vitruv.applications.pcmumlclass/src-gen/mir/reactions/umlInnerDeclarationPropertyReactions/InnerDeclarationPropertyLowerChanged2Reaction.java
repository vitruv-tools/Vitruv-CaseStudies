...
public class InnerDeclarationPropertyLowerChanged2Reaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<LiteralInteger, Integer> replaceChange;
  
  private int currentlyMatchedChange;
  
  public InnerDeclarationPropertyLowerChanged2Reaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInnerDeclarationPropertyReactions.InnerDeclarationPropertyLowerChanged2Reaction.ActionUserExecution userExecution = new mir.reactions.umlInnerDeclarationPropertyReactions.InnerDeclarationPropertyLowerChanged2Reaction.ActionUserExecution(this.executionState, this);
