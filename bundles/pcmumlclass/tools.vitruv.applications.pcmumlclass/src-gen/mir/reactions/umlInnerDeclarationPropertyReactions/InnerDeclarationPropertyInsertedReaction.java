...
public class InnerDeclarationPropertyInsertedReaction extends AbstractReactionRealization {
  private InsertEReference<org.eclipse.uml2.uml.Class, Property> insertChange;
  
  private int currentlyMatchedChange;
  
  public InnerDeclarationPropertyInsertedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInnerDeclarationPropertyReactions.InnerDeclarationPropertyInsertedReaction.ActionUserExecution userExecution = new mir.reactions.umlInnerDeclarationPropertyReactions.InnerDeclarationPropertyInsertedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkUserDefinedPrecondition(final InsertEReference insertChange, final org.eclipse.uml2.uml.Class affectedEObject, final EReference affectedFeature, final Property newValue, final int index) {
    return affectedEObject.getOwnedAttributes().contains(newValue);
  }
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final org.eclipse.uml2.uml.Class affectedEObject, final EReference affectedFeature, final Property newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.insertCorrespondingInnerDeclaration(newValue, affectedEObject);
    }
  }
}
