...
public class InnerDeclarationPropertyUpperChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<Property, ValueSpecification> replaceChange;
  
  private int currentlyMatchedChange;
  
  public InnerDeclarationPropertyUpperChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInnerDeclarationPropertyReactions.InnerDeclarationPropertyUpperChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlInnerDeclarationPropertyReactions.InnerDeclarationPropertyUpperChangedReaction.ActionUserExecution(this.executionState, this);
