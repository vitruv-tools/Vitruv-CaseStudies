...
public class InnerDeclarationPropertyUpperChanged2Reaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<LiteralUnlimitedNatural, Integer> replaceChange;
  
  private int currentlyMatchedChange;
  
  public InnerDeclarationPropertyUpperChanged2Reaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInnerDeclarationPropertyReactions.InnerDeclarationPropertyUpperChanged2Reaction.ActionUserExecution userExecution = new mir.reactions.umlInnerDeclarationPropertyReactions.InnerDeclarationPropertyUpperChanged2Reaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkUserDefinedPrecondition(final ReplaceSingleValuedEAttribute replaceChange, final LiteralUnlimitedNatural affectedEObject, final EAttribute affectedFeature, final Integer oldValue, final Integer newValue) {
    return ((affectedEObject.getOwner() instanceof Property) && (affectedEObject.getValue() == (newValue).intValue()));
  }
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final LiteralUnlimitedNatural affectedEObject, final EAttribute affectedFeature, final Integer oldValue, final Integer newValue, @Extension final RoutinesFacade _routinesFacade) {
      ...
      _routinesFacade.propagateTypeChange(((Property) _owner));
    }
  }
}
