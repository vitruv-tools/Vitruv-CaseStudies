...
public class AssemblyContextPropertyRemovedReaction extends AbstractReactionRealization {
  private RemoveEReference<org.eclipse.uml2.uml.Class, Property> removeChange;
  
  private int currentlyMatchedChange;
  
  public AssemblyContextPropertyRemovedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlAssemblyContextPropertyReactions.AssemblyContextPropertyRemovedReaction.ActionUserExecution userExecution = new mir.reactions.umlAssemblyContextPropertyReactions.AssemblyContextPropertyRemovedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final org.eclipse.uml2.uml.Class affectedEObject, final EReference affectedFeature, final Property oldValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.removeCorrespondingAssemblyContext(oldValue, affectedEObject);
    }
  }
}
