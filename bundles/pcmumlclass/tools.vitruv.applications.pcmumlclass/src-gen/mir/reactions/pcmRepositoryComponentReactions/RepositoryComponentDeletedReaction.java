...
public class RepositoryComponentDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<RepositoryComponent> deleteChange;
  
  private int currentlyMatchedChange;
  
  public RepositoryComponentDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmRepositoryComponentReactions.RepositoryComponentDeletedReaction.ActionUserExecution userExecution = new mir.reactions.pcmRepositoryComponentReactions.RepositoryComponentDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final RepositoryComponent affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingComponentPackage(affectedEObject);
    }
  }
}
