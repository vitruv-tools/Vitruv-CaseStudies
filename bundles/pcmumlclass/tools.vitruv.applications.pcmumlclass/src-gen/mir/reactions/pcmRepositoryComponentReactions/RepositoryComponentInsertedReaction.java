...
public class RepositoryComponentInsertedReaction extends AbstractReactionRealization {
  private InsertEReference<Repository, RepositoryComponent> insertChange;
  
  private int currentlyMatchedChange;
  
  public RepositoryComponentInsertedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmRepositoryComponentReactions.RepositoryComponentInsertedReaction.ActionUserExecution userExecution = new mir.reactions.pcmRepositoryComponentReactions.RepositoryComponentInsertedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final Repository affectedEObject, final EReference affectedFeature, final RepositoryComponent newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.insertCorrespondingComponentPackage(newValue, affectedEObject);
    }
  }
}
