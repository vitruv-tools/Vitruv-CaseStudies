...
public class RequiredRolePropertyInsertedReaction extends AbstractReactionRealization {
  private InsertEReference<org.eclipse.uml2.uml.Class, Property> insertChange;
  
  private int currentlyMatchedChange;
  
  public RequiredRolePropertyInsertedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRequiredRolePropertyReactions.RequiredRolePropertyInsertedReaction.ActionUserExecution userExecution = new mir.reactions.umlRequiredRolePropertyReactions.RequiredRolePropertyInsertedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final org.eclipse.uml2.uml.Class affectedEObject, final EReference affectedFeature, final Property newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.insertCorrespondingRequiredRole(newValue, affectedEObject);
    }
  }
}
