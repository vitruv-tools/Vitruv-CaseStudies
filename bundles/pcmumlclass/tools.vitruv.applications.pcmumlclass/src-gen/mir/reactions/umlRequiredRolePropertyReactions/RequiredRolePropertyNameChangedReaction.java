...
public class RequiredRolePropertyNameChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Property, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RequiredRolePropertyNameChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRequiredRolePropertyReactions.RequiredRolePropertyNameChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlRequiredRolePropertyReactions.RequiredRolePropertyNameChangedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Property affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changeNameOfCorrespondingRequiredRole(affectedEObject, newValue);
    }
  }
}
