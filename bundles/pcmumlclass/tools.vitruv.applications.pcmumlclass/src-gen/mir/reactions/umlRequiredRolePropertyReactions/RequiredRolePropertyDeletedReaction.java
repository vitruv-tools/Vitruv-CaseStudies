...
public class RequiredRolePropertyDeletedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRequiredRolePropertyReactions.RequiredRolePropertyDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlRequiredRolePropertyReactions.RequiredRolePropertyDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Property affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingRequiredRole(affectedEObject);
    }
  }
}
