...
public class RequiredRolePropertyRemovedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRequiredRolePropertyReactions.RequiredRolePropertyRemovedReaction.ActionUserExecution userExecution = new mir.reactions.umlRequiredRolePropertyReactions.RequiredRolePropertyRemovedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final org.eclipse.uml2.uml.Class affectedEObject, final EReference affectedFeature, final Property oldValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.removeCorrespondingRequiredRole(oldValue, affectedEObject);
    }
  }
}
