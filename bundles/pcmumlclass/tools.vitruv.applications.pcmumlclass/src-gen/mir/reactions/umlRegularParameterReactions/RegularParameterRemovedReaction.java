...
public class RegularParameterRemovedReaction extends AbstractReactionRealization {
  private RemoveEReference<Operation, Parameter> removeChange;
  
  private int currentlyMatchedChange;
  
  public RegularParameterRemovedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRegularParameterReactions.RegularParameterRemovedReaction.ActionUserExecution userExecution = new mir.reactions.umlRegularParameterReactions.RegularParameterRemovedReaction.ActionUserExecution(this.executionState, this);
