...
public class RepositoryOrSystemPackageDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<org.eclipse.uml2.uml.Package> deleteChange;
  
  private int currentlyMatchedChange;
  
  public RepositoryOrSystemPackageDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRepositoryAndSystemPackageReactions.RepositoryOrSystemPackageDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlRepositoryAndSystemPackageReactions.RepositoryOrSystemPackageDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final org.eclipse.uml2.uml.Package affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingRepositoryOrSystem(affectedEObject);
    }
  }
}
