...
public class RepositoryOrSystemPackageRenamedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<org.eclipse.uml2.uml.Package, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RepositoryOrSystemPackageRenamedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRepositoryAndSystemPackageReactions.RepositoryOrSystemPackageRenamedReaction.ActionUserExecution userExecution = new mir.reactions.umlRepositoryAndSystemPackageReactions.RepositoryOrSystemPackageRenamedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final org.eclipse.uml2.uml.Package affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.renameCorrespondingRepositoryOrSystem(affectedEObject, newValue);
    }
  }
}
