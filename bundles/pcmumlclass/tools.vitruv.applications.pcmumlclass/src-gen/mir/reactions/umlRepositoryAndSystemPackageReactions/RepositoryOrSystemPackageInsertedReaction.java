...
public class RepositoryOrSystemPackageInsertedReaction extends AbstractReactionRealization {
  private InsertEReference<org.eclipse.uml2.uml.Package, org.eclipse.uml2.uml.Package> insertChange;
  
  private int currentlyMatchedChange;
  
  public RepositoryOrSystemPackageInsertedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRepositoryAndSystemPackageReactions.RepositoryOrSystemPackageInsertedReaction.ActionUserExecution userExecution = new mir.reactions.umlRepositoryAndSystemPackageReactions.RepositoryOrSystemPackageInsertedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final org.eclipse.uml2.uml.Package affectedEObject, final EReference affectedFeature, final org.eclipse.uml2.uml.Package newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.insertCorrespondingRepositoryOrSystem(newValue, affectedEObject);
    }
  }
}
