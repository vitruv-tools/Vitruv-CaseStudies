...
public class SignatureDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<OperationSignature> deleteChange;
  
  private int currentlyMatchedChange;
  
  public SignatureDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmSignatureReactions.SignatureDeletedReaction.ActionUserExecution userExecution = new mir.reactions.pcmSignatureReactions.SignatureDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final OperationSignature affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingOperation(affectedEObject);
    }
  }
}
