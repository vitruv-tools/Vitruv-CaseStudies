...
public class SignatureRenamedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<OperationSignature, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public SignatureRenamedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmSignatureReactions.SignatureRenamedReaction.ActionUserExecution userExecution = new mir.reactions.pcmSignatureReactions.SignatureRenamedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkUserDefinedPrecondition(final ReplaceSingleValuedEAttribute replaceChange, final OperationSignature affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue) {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final OperationSignature affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.renameCorrespondingOperation(affectedEObject, newValue);
    }
  }
}
