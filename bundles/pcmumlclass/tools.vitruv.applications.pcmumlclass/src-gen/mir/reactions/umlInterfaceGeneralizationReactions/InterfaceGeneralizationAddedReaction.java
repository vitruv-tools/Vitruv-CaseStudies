...
public class InterfaceGeneralizationAddedReaction extends AbstractReactionRealization {
  private InsertEReference<Interface, Generalization> insertChange;
  
  private int currentlyMatchedChange;
  
  public InterfaceGeneralizationAddedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlInterfaceGeneralizationReactions.InterfaceGeneralizationAddedReaction.ActionUserExecution userExecution = new mir.reactions.umlInterfaceGeneralizationReactions.InterfaceGeneralizationAddedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final Interface affectedEObject, final EReference affectedFeature, final Generalization newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.addParentInterface(affectedEObject, newValue.getGeneral());
    }
  }
}
