...
public class PackageDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<org.eclipse.uml2.uml.Package> deleteChange;
  
  private int currentlyMatchedChange;
  
  public PackageDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRepositoryComponentPackageReactions.PackageDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlRepositoryComponentPackageReactions.PackageDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final org.eclipse.uml2.uml.Package affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingRepositoryComponent(affectedEObject);
    }
  }
}
