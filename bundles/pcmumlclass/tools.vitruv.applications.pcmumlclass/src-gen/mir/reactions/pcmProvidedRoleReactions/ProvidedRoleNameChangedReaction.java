...
public class ProvidedRoleNameChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<OperationProvidedRole, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ProvidedRoleNameChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmProvidedRoleReactions.ProvidedRoleNameChangedReaction.ActionUserExecution userExecution = new mir.reactions.pcmProvidedRoleReactions.ProvidedRoleNameChangedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkUserDefinedPrecondition(final ReplaceSingleValuedEAttribute replaceChange, final OperationProvidedRole affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue) {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final OperationProvidedRole affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changeNameOfCorrespondingProvidedRealization(affectedEObject, newValue);
    }
  }
}
