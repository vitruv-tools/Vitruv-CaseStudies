...
public class RequiredRolePropertyDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<Parameter> deleteChange;
  
  private int currentlyMatchedChange;
  
  public RequiredRolePropertyDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRequiredRoleParameterReactions.RequiredRolePropertyDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlRequiredRoleParameterReactions.RequiredRolePropertyDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Parameter affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.parameter_deleteCorrespondingRequiredRole(affectedEObject);
    }
  }
}
