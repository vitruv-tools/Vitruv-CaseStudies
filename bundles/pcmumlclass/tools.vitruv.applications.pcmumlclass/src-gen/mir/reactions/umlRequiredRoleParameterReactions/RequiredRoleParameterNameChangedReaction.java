...
public class RequiredRoleParameterNameChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Parameter, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RequiredRoleParameterNameChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlRequiredRoleParameterReactions.RequiredRoleParameterNameChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlRequiredRoleParameterReactions.RequiredRoleParameterNameChangedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Parameter affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.parameter_changeNameOfCorrespondingRequiredRole(affectedEObject, newValue);
    }
  }
}
