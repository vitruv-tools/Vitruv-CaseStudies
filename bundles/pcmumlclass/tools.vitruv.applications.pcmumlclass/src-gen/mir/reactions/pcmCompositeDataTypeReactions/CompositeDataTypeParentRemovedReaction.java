...
public class CompositeDataTypeParentRemovedReaction extends AbstractReactionRealization {
  private RemoveEReference<CompositeDataType, CompositeDataType> removeChange;
  
  private int currentlyMatchedChange;
  
  public CompositeDataTypeParentRemovedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmCompositeDataTypeReactions.CompositeDataTypeParentRemovedReaction.ActionUserExecution userExecution = new mir.reactions.pcmCompositeDataTypeReactions.CompositeDataTypeParentRemovedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final CompositeDataType affectedEObject, final EReference affectedFeature, final CompositeDataType oldValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.removeParentTypeFromCorrespondingCompositeTypeClass(affectedEObject, oldValue);
    }
  }
}
