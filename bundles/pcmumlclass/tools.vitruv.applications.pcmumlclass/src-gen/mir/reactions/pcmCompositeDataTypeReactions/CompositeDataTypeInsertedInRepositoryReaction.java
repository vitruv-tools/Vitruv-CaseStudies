...
public class CompositeDataTypeInsertedInRepositoryReaction extends AbstractReactionRealization {
  private InsertEReference<Repository, CompositeDataType> insertChange;
  
  private int currentlyMatchedChange;
  
  public CompositeDataTypeInsertedInRepositoryReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmCompositeDataTypeReactions.CompositeDataTypeInsertedInRepositoryReaction.ActionUserExecution userExecution = new mir.reactions.pcmCompositeDataTypeReactions.CompositeDataTypeInsertedInRepositoryReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final Repository affectedEObject, final EReference affectedFeature, final CompositeDataType newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.insertCorrespondingCompositeTypeClass(newValue, affectedEObject);
    }
  }
}
