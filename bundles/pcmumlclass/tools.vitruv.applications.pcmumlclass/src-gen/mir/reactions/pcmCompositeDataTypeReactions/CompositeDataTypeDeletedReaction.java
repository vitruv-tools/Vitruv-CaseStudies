...
public class CompositeDataTypeDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<CompositeDataType> deleteChange;
  
  private int currentlyMatchedChange;
  
  public CompositeDataTypeDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmCompositeDataTypeReactions.CompositeDataTypeDeletedReaction.ActionUserExecution userExecution = new mir.reactions.pcmCompositeDataTypeReactions.CompositeDataTypeDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final CompositeDataType affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingCompositeTypeClass(affectedEObject);
    }
  }
}
