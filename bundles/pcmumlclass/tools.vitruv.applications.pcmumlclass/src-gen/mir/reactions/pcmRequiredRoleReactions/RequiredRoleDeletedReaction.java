...
public class RequiredRoleDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<OperationRequiredRole> deleteChange;
  
  private int currentlyMatchedChange;
  
  public RequiredRoleDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmRequiredRoleReactions.RequiredRoleDeletedReaction.ActionUserExecution userExecution = new mir.reactions.pcmRequiredRoleReactions.RequiredRoleDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final OperationRequiredRole affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingRequiredElements(affectedEObject);
    }
  }
}
