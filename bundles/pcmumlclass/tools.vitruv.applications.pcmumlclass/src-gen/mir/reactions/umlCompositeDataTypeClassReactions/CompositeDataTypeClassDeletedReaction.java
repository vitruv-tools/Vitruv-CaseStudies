...
public class CompositeDataTypeClassDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<org.eclipse.uml2.uml.Class> deleteChange;
  
  private int currentlyMatchedChange;
  
  public CompositeDataTypeClassDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlCompositeDataTypeClassReactions.CompositeDataTypeClassDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlCompositeDataTypeClassReactions.CompositeDataTypeClassDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final org.eclipse.uml2.uml.Class affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingCompositeDataType(affectedEObject);
    }
  }
}
