...
public class CompositeDataTypeClassNameChangedReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<org.eclipse.uml2.uml.Class, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public CompositeDataTypeClassNameChangedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlCompositeDataTypeClassReactions.CompositeDataTypeClassNameChangedReaction.ActionUserExecution userExecution = new mir.reactions.umlCompositeDataTypeClassReactions.CompositeDataTypeClassNameChangedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final org.eclipse.uml2.uml.Class affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changeNameOfCorrespondingCompositeDataType(affectedEObject, newValue);
    }
  }
}
