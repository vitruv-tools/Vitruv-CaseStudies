...
public class CompositeDataTypeClassRemovedReaction extends AbstractReactionRealization {
  private RemoveEReference<org.eclipse.uml2.uml.Package, org.eclipse.uml2.uml.Class> removeChange;
  
  private int currentlyMatchedChange;
  
  public CompositeDataTypeClassRemovedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlCompositeDataTypeClassReactions.CompositeDataTypeClassRemovedReaction.ActionUserExecution userExecution = new mir.reactions.umlCompositeDataTypeClassReactions.CompositeDataTypeClassRemovedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final org.eclipse.uml2.uml.Package affectedEObject, final EReference affectedFeature, final org.eclipse.uml2.uml.Class oldValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.removeCorrespondingCompositeType(oldValue, affectedEObject);
    }
  }
}
