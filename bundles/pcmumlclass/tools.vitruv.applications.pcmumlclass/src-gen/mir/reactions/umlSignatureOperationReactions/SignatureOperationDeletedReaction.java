...
public class SignatureOperationDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<Operation> deleteChange;
  
  private int currentlyMatchedChange;
  
  public SignatureOperationDeletedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlSignatureOperationReactions.SignatureOperationDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlSignatureOperationReactions.SignatureOperationDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Operation affectedEObject, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.deleteCorrespondingSignature(affectedEObject);
    }
  }
}
