...
public class DefaultLiterals {
	...
	public static final String INPUT_REQUEST_DELETE_CORRESPONDING_UML_MODEL = "Are you sure you want to delete the UML model associated with this PCM repository?";
