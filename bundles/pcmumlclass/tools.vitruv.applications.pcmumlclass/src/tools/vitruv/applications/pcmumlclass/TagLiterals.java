...
public class TagLiterals {
	...
	/**
	 * should be used for both PrimitiveDatatype and CompositeDatatype correspondences
	 */
	...
	// RepositoryComponent- and System-reactions manage the correspondences below (create, move, delete, rename), 
	// but the shared reference-features regarding ProvidedRole, RequiredRole are synchronized across the more general 
	// InterfaceProvidingRequiringEntity (IPRE) correspondence relations.
	// Similarly ComposedProvidingRequiringEntity (CPRE), a subclass of IPRE, uses the shared IPRE__IMPLEMENTATION correspondence
