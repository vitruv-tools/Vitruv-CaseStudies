...
public class RegularOrReturnParameterLowerChanged2Reaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<LiteralInteger, Integer> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RegularOrReturnParameterLowerChanged2Reaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlReturnAndRegularParameterTypeReactions.RegularOrReturnParameterLowerChanged2Reaction.ActionUserExecution userExecution = new mir.reactions.umlReturnAndRegularParameterTypeReactions.RegularOrReturnParameterLowerChanged2Reaction.ActionUserExecution(this.executionState, this);
