...
public class RegularOrReturnParameterUpperChanged2Reaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<LiteralUnlimitedNatural, Integer> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RegularOrReturnParameterUpperChanged2Reaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlReturnAndRegularParameterTypeReactions.RegularOrReturnParameterUpperChanged2Reaction.ActionUserExecution userExecution = new mir.reactions.umlReturnAndRegularParameterTypeReactions.RegularOrReturnParameterUpperChanged2Reaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final LiteralUnlimitedNatural affectedEObject, final EAttribute affectedFeature, final Integer oldValue, final Integer newValue, @Extension final RoutinesFacade _routinesFacade) {
      ...
      _routinesFacade.propagateTypeChange(((Parameter) _owner));
    }
  }
}
