...
import mir.routines.combinedUmlToPcm.RoutinesFacade;
...
public class OnParameterDirectionReplacedAtParameterReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Parameter, ParameterDirectionKind> replaceChange;
  
  private int currentlyMatchedChange;
  
  public OnParameterDirectionReplacedAtParameterReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.combinedUmlToPcm.OnParameterDirectionReplacedAtParameterReaction.ActionUserExecution userExecution = new mir.reactions.combinedUmlToPcm.OnParameterDirectionReplacedAtParameterReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Parameter affectedEObject, final EAttribute affectedFeature, final ParameterDirectionKind oldValue, final ParameterDirectionKind newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.umlXpcmSignature_L2R.signature_ElementUpdatedCheck(affectedEObject);
    }
  }
}
