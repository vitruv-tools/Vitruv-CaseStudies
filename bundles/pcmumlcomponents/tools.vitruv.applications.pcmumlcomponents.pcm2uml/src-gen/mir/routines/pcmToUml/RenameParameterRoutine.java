...
public class RenameParameterRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public EObject getElement2(final Parameter pcmParameter, final org.eclipse.uml2.uml.Parameter umlParameter) {
      return pcmParameter;
    }
    ...
    public void update1Element(final Parameter pcmParameter, final org.eclipse.uml2.uml.Parameter umlParameter) {
  ...
  protected void executeRoutine() throws IOException {
    ...
    // val updatedElement userExecution.getElement2(pcmParameter, umlParameter);
    userExecution.update1Element(pcmParameter, umlParameter);
