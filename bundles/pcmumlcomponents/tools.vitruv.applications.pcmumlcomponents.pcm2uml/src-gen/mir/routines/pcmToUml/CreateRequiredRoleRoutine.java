...
public class CreateRequiredRoleRoutine extends AbstractRepairRoutineRealization {
  ...
  public CreateRequiredRoleRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final InterfaceRequiringEntity pcmComponent, final OperationRequiredRole requiredRole) {
