...
public class ChangeParameterTypeRoutine extends AbstractRepairRoutineRealization {
  ...
  public ChangeParameterTypeRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Parameter pcmParameter, final DataType pcmDataType) {
