...
class ChangedCollectionDataTypeTypeReaction extends AbstractReactionRealization {
  public ChangedCollectionDataTypeTypeReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsPcmToUml.pcmToUml.ChangedCollectionDataTypeTypeReaction.ActionUserExecution userExecution = new mir.reactions.reactionsPcmToUml.pcmToUml.ChangedCollectionDataTypeTypeReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final CollectionDataType affectedEObject, final EReference affectedFeature, final DataType oldValue, final DataType newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changeCollectionDataTypeType(affectedEObject, newValue);
    }
  }
}
