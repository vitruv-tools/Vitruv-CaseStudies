...
class CreatedOperationInterfaceSignatureReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.CreatedOperationInterfaceSignatureReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.CreatedOperationInterfaceSignatureReaction.ActionUserExecution(this.executionState, this);
