...
class DeletedComponentReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.DeletedComponentReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.DeletedComponentReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkChangeProperties(final EChange change) {
    RemoveEReference<Repository, RepositoryComponent> relevantChange = (RemoveEReference<Repository, RepositoryComponent>)change;
