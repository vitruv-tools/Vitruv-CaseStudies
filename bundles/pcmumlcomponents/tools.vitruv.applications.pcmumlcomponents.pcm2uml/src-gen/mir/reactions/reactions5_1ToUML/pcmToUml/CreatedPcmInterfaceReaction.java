...
class CreatedPcmInterfaceReaction extends AbstractReactionRealization {
  public CreatedPcmInterfaceReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.CreatedPcmInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.CreatedPcmInterfaceReaction.ActionUserExecution(this.executionState, this);
