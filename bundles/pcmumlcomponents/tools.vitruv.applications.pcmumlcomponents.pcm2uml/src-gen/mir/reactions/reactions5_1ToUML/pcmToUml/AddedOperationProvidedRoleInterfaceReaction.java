...
class AddedOperationProvidedRoleInterfaceReaction extends AbstractReactionRealization {
  public AddedOperationProvidedRoleInterfaceReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.AddedOperationProvidedRoleInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.AddedOperationProvidedRoleInterfaceReaction.ActionUserExecution(this.executionState, this);
