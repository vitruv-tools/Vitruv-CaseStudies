...
class CreatedBasicPcmComponentReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.CreatedBasicPcmComponentReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.CreatedBasicPcmComponentReaction.ActionUserExecution(this.executionState, this);
