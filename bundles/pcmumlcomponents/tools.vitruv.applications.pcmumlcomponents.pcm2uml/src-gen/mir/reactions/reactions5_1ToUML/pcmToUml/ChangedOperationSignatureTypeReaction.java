...
class ChangedOperationSignatureTypeReaction extends AbstractReactionRealization {
  public ChangedOperationSignatureTypeReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.ChangedOperationSignatureTypeReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.ChangedOperationSignatureTypeReaction.ActionUserExecution(this.executionState, this);
