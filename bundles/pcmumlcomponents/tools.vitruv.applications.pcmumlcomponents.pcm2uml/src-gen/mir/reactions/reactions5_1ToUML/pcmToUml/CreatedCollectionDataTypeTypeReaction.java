...
class CreatedCollectionDataTypeTypeReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.CreatedCollectionDataTypeTypeReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.CreatedCollectionDataTypeTypeReaction.ActionUserExecution(this.executionState, this);
