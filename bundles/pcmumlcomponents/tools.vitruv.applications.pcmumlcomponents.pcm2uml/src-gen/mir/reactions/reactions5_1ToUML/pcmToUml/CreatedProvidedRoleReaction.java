...
class CreatedProvidedRoleReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.CreatedProvidedRoleReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.CreatedProvidedRoleReaction.ActionUserExecution(this.executionState, this);
