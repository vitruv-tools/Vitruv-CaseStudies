...
class CreatedPrimitiveDataTypeReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToUML.pcmToUml.CreatedPrimitiveDataTypeReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToUML.pcmToUml.CreatedPrimitiveDataTypeReaction.ActionUserExecution(this.executionState, this);
