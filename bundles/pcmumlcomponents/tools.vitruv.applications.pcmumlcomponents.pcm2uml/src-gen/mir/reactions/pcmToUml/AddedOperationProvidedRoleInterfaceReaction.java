...
public class AddedOperationProvidedRoleInterfaceReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<OperationProvidedRole, OperationInterface> replaceChange;
  
  private int currentlyMatchedChange;
  
  public AddedOperationProvidedRoleInterfaceReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.AddedOperationProvidedRoleInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.AddedOperationProvidedRoleInterfaceReaction.ActionUserExecution(this.executionState, this);
