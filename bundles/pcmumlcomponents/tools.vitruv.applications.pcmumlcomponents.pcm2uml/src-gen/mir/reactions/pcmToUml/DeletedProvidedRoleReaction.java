...
public class DeletedProvidedRoleReaction extends AbstractReactionRealization {
  private RemoveEReference<InterfaceProvidingEntity, ProvidedRole> removeChange;
  
  private int currentlyMatchedChange;
  
  public DeletedProvidedRoleReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.DeletedProvidedRoleReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.DeletedProvidedRoleReaction.ActionUserExecution(this.executionState, this);
