...
public class RemovedCompositeDataTypeParentReaction extends AbstractReactionRealization {
  private RemoveEReference<CompositeDataType, CompositeDataType> removeChange;
  
  private int currentlyMatchedChange;
  
  public RemovedCompositeDataTypeParentReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.RemovedCompositeDataTypeParentReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.RemovedCompositeDataTypeParentReaction.ActionUserExecution(this.executionState, this);
