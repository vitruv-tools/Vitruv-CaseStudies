...
public class CreatedPcmInterfaceReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.CreatedPcmInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.CreatedPcmInterfaceReaction.ActionUserExecution(this.executionState, this);
