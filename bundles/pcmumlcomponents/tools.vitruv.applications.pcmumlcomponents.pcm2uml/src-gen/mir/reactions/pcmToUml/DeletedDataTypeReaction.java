...
public class DeletedDataTypeReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.DeletedDataTypeReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.DeletedDataTypeReaction.ActionUserExecution(this.executionState, this);
