...
public class ChangedInnerDeclarationTypeReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<InnerDeclaration, DataType> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedInnerDeclarationTypeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.ChangedInnerDeclarationTypeReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.ChangedInnerDeclarationTypeReaction.ActionUserExecution(this.executionState, this);
