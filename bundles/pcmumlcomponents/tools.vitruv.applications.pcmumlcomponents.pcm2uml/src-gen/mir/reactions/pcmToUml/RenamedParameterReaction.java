...
public class RenamedParameterReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.RenamedParameterReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.RenamedParameterReaction.ActionUserExecution(this.executionState, this);
