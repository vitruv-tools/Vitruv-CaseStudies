...
public class ChangedOperationSignatureTypeReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<OperationSignature, DataType> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedOperationSignatureTypeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.ChangedOperationSignatureTypeReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.ChangedOperationSignatureTypeReaction.ActionUserExecution(this.executionState, this);
