...
public class CreatedProvidedRoleReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.CreatedProvidedRoleReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.CreatedProvidedRoleReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final InterfaceProvidingEntity affectedEObject, final EReference affectedFeature, final ProvidedRole newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
