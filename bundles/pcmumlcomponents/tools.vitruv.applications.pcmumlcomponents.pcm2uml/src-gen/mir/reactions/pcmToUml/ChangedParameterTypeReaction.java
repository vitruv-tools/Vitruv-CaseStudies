...
public class ChangedParameterTypeReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcmToUml.ChangedParameterTypeReaction.ActionUserExecution userExecution = new mir.reactions.pcmToUml.ChangedParameterTypeReaction.ActionUserExecution(this.executionState, this);
