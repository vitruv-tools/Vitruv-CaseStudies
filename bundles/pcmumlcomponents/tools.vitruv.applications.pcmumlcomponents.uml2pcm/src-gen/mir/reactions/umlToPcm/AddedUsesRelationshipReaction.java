...
public class AddedUsesRelationshipReaction extends AbstractReactionRealization {
  private InsertEReference<Component, Usage> insertChange;
  
  private int currentlyMatchedChange;
  
  public AddedUsesRelationshipReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToPcm.AddedUsesRelationshipReaction.ActionUserExecution userExecution = new mir.reactions.umlToPcm.AddedUsesRelationshipReaction.ActionUserExecution(this.executionState, this);
