...
public class ChangedMultiplicityLowerValueReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<MultiplicityElement, ValueSpecification> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedMultiplicityLowerValueReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToPcm.ChangedMultiplicityLowerValueReaction.ActionUserExecution userExecution = new mir.reactions.umlToPcm.ChangedMultiplicityLowerValueReaction.ActionUserExecution(this.executionState, this);
