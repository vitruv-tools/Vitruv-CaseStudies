...
public class RemovedInterfaceRealizationInterfaceReaction extends AbstractReactionRealization {
  private RemoveEReference<InterfaceRealization, Interface> removeChange;
  
  private int currentlyMatchedChange;
  
  public RemovedInterfaceRealizationInterfaceReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToPcm.RemovedInterfaceRealizationInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.umlToPcm.RemovedInterfaceRealizationInterfaceReaction.ActionUserExecution(this.executionState, this);
