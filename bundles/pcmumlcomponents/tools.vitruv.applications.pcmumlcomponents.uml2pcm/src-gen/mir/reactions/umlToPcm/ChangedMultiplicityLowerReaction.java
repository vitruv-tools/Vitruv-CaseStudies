...
public class ChangedMultiplicityLowerReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<MultiplicityElement, Integer> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedMultiplicityLowerReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToPcm.ChangedMultiplicityLowerReaction.ActionUserExecution userExecution = new mir.reactions.umlToPcm.ChangedMultiplicityLowerReaction.ActionUserExecution(this.executionState, this);
