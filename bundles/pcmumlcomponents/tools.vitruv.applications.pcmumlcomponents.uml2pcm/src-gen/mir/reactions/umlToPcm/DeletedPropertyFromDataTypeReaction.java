...
public class DeletedPropertyFromDataTypeReaction extends AbstractReactionRealization {
  private RemoveEReference<DataType, Property> removeChange;
  
  private int currentlyMatchedChange;
  
  public DeletedPropertyFromDataTypeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToPcm.DeletedPropertyFromDataTypeReaction.ActionUserExecution userExecution = new mir.reactions.umlToPcm.DeletedPropertyFromDataTypeReaction.ActionUserExecution(this.executionState, this);
