...
public class ChangedMultiplicityUpperReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<MultiplicityElement, Integer> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedMultiplicityUpperReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlToPcm.ChangedMultiplicityUpperReaction.ActionUserExecution userExecution = new mir.reactions.umlToPcm.ChangedMultiplicityUpperReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean matchReplaceChange(final EChange change) {
    if (change instanceof ReplaceSingleValuedEAttribute<?, ?>) {
    	...
    	if (!_localTypedChange.getAffectedFeature().getName().equals("upper")) {
    		return false;
    	}
