...
class ChangedInterfaceRealizationInterfaceReaction extends AbstractReactionRealization {
  public ChangedInterfaceRealizationInterfaceReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLTo5_1.umlToPcm.ChangedInterfaceRealizationInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLTo5_1.umlToPcm.ChangedInterfaceRealizationInterfaceReaction.ActionUserExecution(this.executionState, this);
