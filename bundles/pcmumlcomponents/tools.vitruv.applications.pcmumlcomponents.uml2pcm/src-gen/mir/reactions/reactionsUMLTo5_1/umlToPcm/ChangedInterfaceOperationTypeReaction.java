...
class ChangedInterfaceOperationTypeReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ReplaceSingleValuedEReference<Operation, Type> typedChange = (ReplaceSingleValuedEReference<Operation, Type>)change;
  ...
  private boolean checkChangeProperties(final EChange change) {
    ReplaceSingleValuedEReference<Operation, Type> relevantChange = (ReplaceSingleValuedEReference<Operation, Type>)change;
  ...
  private boolean checkUserDefinedPrecondition(final Operation affectedEObject, final EReference affectedFeature, final Type oldValue, final Type newValue) {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Operation affectedEObject, final EReference affectedFeature, final Type oldValue, final Type newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changeInterfaceOperationType(affectedEObject, newValue);
    }
  }
}
