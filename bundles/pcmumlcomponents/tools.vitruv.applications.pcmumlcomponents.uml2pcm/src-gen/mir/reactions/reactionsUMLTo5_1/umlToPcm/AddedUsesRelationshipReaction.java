...
class AddedUsesRelationshipReaction extends AbstractReactionRealization {
  public AddedUsesRelationshipReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLTo5_1.umlToPcm.AddedUsesRelationshipReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLTo5_1.umlToPcm.AddedUsesRelationshipReaction.ActionUserExecution(this.executionState, this);
