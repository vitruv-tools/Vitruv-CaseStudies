...
class RemovedInterfaceRealizationRelationshipReaction extends AbstractReactionRealization {
  public RemovedInterfaceRealizationRelationshipReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLTo5_1.umlToPcm.RemovedInterfaceRealizationRelationshipReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLTo5_1.umlToPcm.RemovedInterfaceRealizationRelationshipReaction.ActionUserExecution(this.executionState, this);
