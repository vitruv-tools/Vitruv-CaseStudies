...
class ChangedUsesRelationshipInterfaceReaction extends AbstractReactionRealization {
  public ChangedUsesRelationshipInterfaceReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLTo5_1.umlToPcm.ChangedUsesRelationshipInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLTo5_1.umlToPcm.ChangedUsesRelationshipInterfaceReaction.ActionUserExecution(this.executionState, this);
