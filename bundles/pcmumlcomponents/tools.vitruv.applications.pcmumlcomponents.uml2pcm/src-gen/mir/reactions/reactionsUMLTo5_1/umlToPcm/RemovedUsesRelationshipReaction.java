...
class RemovedUsesRelationshipReaction extends AbstractReactionRealization {
  public RemovedUsesRelationshipReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLTo5_1.umlToPcm.RemovedUsesRelationshipReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLTo5_1.umlToPcm.RemovedUsesRelationshipReaction.ActionUserExecution(this.executionState, this);
