...
public class ExecutorUMLTo5_1 extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(mir.reactions.reactionsUMLTo5_1.umlToPcm.DeletedPropertyFromDataTypeReaction.getExpectedChangeType(), new mir.reactions.reactionsUMLTo5_1.umlToPcm.DeletedPropertyFromDataTypeReaction(userInteracting));
