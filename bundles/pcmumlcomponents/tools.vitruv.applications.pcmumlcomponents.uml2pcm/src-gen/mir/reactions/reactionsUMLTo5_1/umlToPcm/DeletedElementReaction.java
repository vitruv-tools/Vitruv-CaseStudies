...
class DeletedElementReaction extends AbstractReactionRealization {
  public DeletedElementReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLTo5_1.umlToPcm.DeletedElementReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLTo5_1.umlToPcm.DeletedElementReaction.ActionUserExecution(this.executionState, this);
