...
class CreatedInterfaceOperationReaction extends AbstractReactionRealization {
  public CreatedInterfaceOperationReaction(final UserInteracting userInteracting) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsUMLTo5_1.umlToPcm.CreatedInterfaceOperationReaction.ActionUserExecution userExecution = new mir.reactions.reactionsUMLTo5_1.umlToPcm.CreatedInterfaceOperationReaction.ActionUserExecution(this.executionState, this);
