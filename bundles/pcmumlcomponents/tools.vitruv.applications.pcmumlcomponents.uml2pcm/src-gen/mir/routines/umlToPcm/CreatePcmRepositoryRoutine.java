...
public class CreatePcmRepositoryRoutine extends AbstractRepairRoutineRealization {
  ...
  public CreatePcmRepositoryRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Model umlModel) {
