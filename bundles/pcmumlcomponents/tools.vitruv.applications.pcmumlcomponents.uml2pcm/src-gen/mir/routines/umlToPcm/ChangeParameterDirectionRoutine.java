...
public class ChangeParameterDirectionRoutine extends AbstractRepairRoutineRealization {
  ...
  public ChangeParameterDirectionRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Parameter umlParameter) {
