...
public class CreateProvidedRoleRoutine extends AbstractRepairRoutineRealization {
  ...
  public CreateProvidedRoleRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Component umlComponent, final InterfaceRealization interfaceRealization) {
