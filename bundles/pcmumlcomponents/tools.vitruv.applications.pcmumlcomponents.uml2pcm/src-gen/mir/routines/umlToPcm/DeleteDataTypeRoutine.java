...
public class DeleteDataTypeRoutine extends AbstractRepairRoutineRealization {
  ...
  public DeleteDataTypeRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final DataType umlDataType) {
