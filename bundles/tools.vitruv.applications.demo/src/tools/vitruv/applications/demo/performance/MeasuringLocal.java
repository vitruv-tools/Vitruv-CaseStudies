...
public class MeasuringLocal {
	public static void main(String[] args) throws Exception {
		...
		measureLocalPerformance(Configuration.REPETITIONS, root.resolve("local-small"), root.resolve("local-small.csv"), Configuration.SMALL_MODEL_PARAMETERS);
		System.out.println("--- Medium configuration with local Vitruvius ---");
		measureLocalPerformance(Configuration.REPETITIONS, root.resolve("local-medium"), root.resolve("local-medium.csv"), Configuration.MEDIUM_MODEL_PARAMETERS);
		System.out.println("--- Large configuration with local Vitruvius ---");
		measureLocalPerformance(Configuration.REPETITIONS, root.resolve("local-large"), root.resolve("local-large.csv"), Configuration.LARGE_MODEL_PARAMETERS);
	}
