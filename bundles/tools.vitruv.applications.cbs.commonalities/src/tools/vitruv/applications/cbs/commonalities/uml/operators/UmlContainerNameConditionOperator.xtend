...
class UmlContainerNameConditionOperator extends AbstractNoArgumentConditionOperator {

	static val Logger logger = Logger.getLogger(UmlContainerNameConditionOperator)
