...
public class CreateAnnotationForFieldReaction extends AbstractReactionRealization {
  private InsertEReference<Field, AnnotationInstanceOrModifier> insertChange;
  
  private int currentlyMatchedChange;
  
  public CreateAnnotationForFieldReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.ejbjava2pcm.CreateAnnotationForFieldReaction.ActionUserExecution userExecution = new mir.reactions.ejbjava2pcm.CreateAnnotationForFieldReaction.ActionUserExecution(this.executionState, this);
