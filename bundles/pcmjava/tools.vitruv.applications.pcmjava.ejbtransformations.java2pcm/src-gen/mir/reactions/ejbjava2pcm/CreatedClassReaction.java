...
public class CreatedClassReaction extends AbstractReactionRealization {
  private InsertEReference<CompilationUnit, ConcreteClassifier> insertChange;
  
  private int currentlyMatchedChange;
  
  public CreatedClassReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.ejbjava2pcm.CreatedClassReaction.ActionUserExecution userExecution = new mir.reactions.ejbjava2pcm.CreatedClassReaction.ActionUserExecution(this.executionState, this);
