...
public class CreatedFirstPackageReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.ejbjava2pcm.CreatedFirstPackageReaction.ActionUserExecution userExecution = new mir.reactions.ejbjava2pcm.CreatedFirstPackageReaction.ActionUserExecution(this.executionState, this);
