...
public class CreateFieldReaction extends AbstractReactionRealization {
  private InsertEReference<org.emftext.language.java.classifiers.Class, Member> insertChange;
  
  private int currentlyMatchedChange;
  
  public CreateFieldReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.ejbjava2pcm.CreateFieldReaction.ActionUserExecution userExecution = new mir.reactions.ejbjava2pcm.CreateFieldReaction.ActionUserExecution(this.executionState, this);
