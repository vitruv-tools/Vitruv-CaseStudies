...
class RenamedParameterReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsPcmToJava.pcm2java.RenamedParameterReaction.ActionUserExecution userExecution = new mir.reactions.reactionsPcmToJava.pcm2java.RenamedParameterReaction.ActionUserExecution(this.executionState, this);
