...
public class AddProvidedRoleRoutine extends AbstractRepairRoutineRealization {
  ...
  public AddProvidedRoleRoutine(final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final OperationProvidedRole providedRole) {
    ...
    this.userExecution = new mir.routines.pcm2depInjectJava.AddProvidedRoleRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected void executeRoutine() throws IOException {
    ...
    org.emftext.language.java.imports.ClassifierImport interfaceImport = ImportsFactoryImpl.eINSTANCE.createClassifierImport();
    ...
    org.emftext.language.java.types.NamespaceClassifierReference namespaceClassifierReference = TypesFactoryImpl.eINSTANCE.createNamespaceClassifierReference();
