...
public class RoutinesFacade extends AbstractRepairRoutinesFacade {
  ...
  public boolean addConnector(final AssemblyConnector assemblyConnector) {
    mir.routines.pcm2depInjectJava.RoutinesFacade _routinesFacade = this;
  ...
  public boolean createRepositorySubPackages(final Repository repository) {
    mir.routines.pcm2javaCommon.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(tools.vitruv.extensions.dslsruntime.reactions.structure.ReactionsImportPath.fromPathString("pcm2javaCommon")));
