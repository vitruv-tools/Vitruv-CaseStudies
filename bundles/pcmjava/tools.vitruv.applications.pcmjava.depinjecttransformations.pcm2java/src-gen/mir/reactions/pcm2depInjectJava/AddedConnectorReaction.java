...
public class AddedConnectorReaction extends AbstractReactionRealization {
  ...
  public AddedConnectorReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2depInjectJava.AddedConnectorReaction.ActionUserExecution userExecution = new mir.reactions.pcm2depInjectJava.AddedConnectorReaction.ActionUserExecution(this.executionState, this);
