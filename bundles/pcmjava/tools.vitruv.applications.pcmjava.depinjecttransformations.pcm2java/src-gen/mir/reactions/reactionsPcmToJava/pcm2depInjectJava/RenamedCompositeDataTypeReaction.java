...
class RenamedCompositeDataTypeReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsPcmToJava.pcm2depInjectJava.RenamedCompositeDataTypeReaction.ActionUserExecution userExecution = new mir.reactions.reactionsPcmToJava.pcm2depInjectJava.RenamedCompositeDataTypeReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkChangeProperties(final EChange change) {
    ReplaceSingleValuedEAttribute<org.palladiosimulator.pcm.repository.CompositeDataType, java.lang.String> relevantChange = (ReplaceSingleValuedEAttribute<org.palladiosimulator.pcm.repository.CompositeDataType, java.lang.String>)change;
