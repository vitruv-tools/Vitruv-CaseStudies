...
class CreatedInnerDeclarationReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2depInjectJava.CreatedInnerDeclarationReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2depInjectJava.CreatedInnerDeclarationReaction.ActionUserExecution(this.executionState, this);
