...
class ChangedParameterTypeReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2depInjectJava.ChangedParameterTypeReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2depInjectJava.ChangedParameterTypeReaction.ActionUserExecution(this.executionState, this);
