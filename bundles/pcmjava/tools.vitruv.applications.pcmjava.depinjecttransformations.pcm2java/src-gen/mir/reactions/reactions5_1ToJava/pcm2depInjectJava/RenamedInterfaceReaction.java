...
class RenamedInterfaceReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2depInjectJava.RenamedInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2depInjectJava.RenamedInterfaceReaction.ActionUserExecution(this.executionState, this);
