...
class RenameOperationRequiredRoleReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2depInjectJava.RenameOperationRequiredRoleReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2depInjectJava.RenameOperationRequiredRoleReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkChangeProperties(final EChange change) {
    ReplaceSingleValuedEAttribute<OperationRequiredRole, String> relevantChange = (ReplaceSingleValuedEAttribute<OperationRequiredRole, String>)change;
