...
class ChangeOperationRequiredRoleEntityResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.ChangeOperationRequiredRoleEntityEffect effect = new mir.routines.pcm2javaDepInject.ChangeOperationRequiredRoleEntityEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
