...
class CreatedResourceDemandingInternalBehaviorResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.CreatedResourceDemandingInternalBehaviorEffect effect = new mir.routines.pcm2javaDepInject.CreatedResourceDemandingInternalBehaviorEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
