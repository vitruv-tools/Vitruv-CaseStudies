...
class ChangedParameterTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.ChangedParameterTypeEffect effect = new mir.routines.pcm2javaDepInject.ChangedParameterTypeEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
