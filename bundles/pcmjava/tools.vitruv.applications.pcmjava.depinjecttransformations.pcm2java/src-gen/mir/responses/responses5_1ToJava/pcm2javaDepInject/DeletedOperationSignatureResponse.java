...
class DeletedOperationSignatureResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.DeletedOperationSignatureEffect effect = new mir.routines.pcm2javaDepInject.DeletedOperationSignatureEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
