...
class CreatedComponentResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.CreatedComponentEffect effect = new mir.routines.pcm2javaDepInject.CreatedComponentEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
