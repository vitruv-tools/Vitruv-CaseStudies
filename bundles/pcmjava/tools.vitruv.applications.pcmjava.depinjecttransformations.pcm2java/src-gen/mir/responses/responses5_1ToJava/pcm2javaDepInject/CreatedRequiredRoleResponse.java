...
class CreatedRequiredRoleResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.CreatedRequiredRoleEffect effect = new mir.routines.pcm2javaDepInject.CreatedRequiredRoleEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
