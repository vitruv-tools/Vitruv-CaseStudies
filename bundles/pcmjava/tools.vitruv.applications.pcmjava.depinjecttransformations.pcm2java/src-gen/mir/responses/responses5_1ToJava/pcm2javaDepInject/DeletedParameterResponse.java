...
class DeletedParameterResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.DeletedParameterEffect effect = new mir.routines.pcm2javaDepInject.DeletedParameterEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
