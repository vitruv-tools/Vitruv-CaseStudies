...
class RenameOperationRequiredRoleResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.RenameOperationRequiredRoleEffect effect = new mir.routines.pcm2javaDepInject.RenameOperationRequiredRoleEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
