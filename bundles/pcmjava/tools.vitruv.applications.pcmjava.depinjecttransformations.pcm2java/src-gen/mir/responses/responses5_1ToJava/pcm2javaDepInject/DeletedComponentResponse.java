...
class DeletedComponentResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.DeletedComponentEffect effect = new mir.routines.pcm2javaDepInject.DeletedComponentEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
