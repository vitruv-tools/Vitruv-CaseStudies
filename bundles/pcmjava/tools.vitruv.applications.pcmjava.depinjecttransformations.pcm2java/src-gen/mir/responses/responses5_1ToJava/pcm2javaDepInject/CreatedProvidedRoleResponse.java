...
class CreatedProvidedRoleResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.CreatedProvidedRoleEffect effect = new mir.routines.pcm2javaDepInject.CreatedProvidedRoleEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
