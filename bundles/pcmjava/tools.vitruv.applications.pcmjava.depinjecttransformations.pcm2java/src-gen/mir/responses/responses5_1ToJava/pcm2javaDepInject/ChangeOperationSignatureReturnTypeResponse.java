...
class ChangeOperationSignatureReturnTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.ChangeOperationSignatureReturnTypeEffect effect = new mir.routines.pcm2javaDepInject.ChangeOperationSignatureReturnTypeEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
