...
class RenameResourceDemandingInternalBehaviorResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.RenameResourceDemandingInternalBehaviorEffect effect = new mir.routines.pcm2javaDepInject.RenameResourceDemandingInternalBehaviorEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
