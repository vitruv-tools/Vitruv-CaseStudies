...
class ChangeOperationRequiredRoleInterfaceResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.ChangeOperationRequiredRoleInterfaceEffect effect = new mir.routines.pcm2javaDepInject.ChangeOperationRequiredRoleInterfaceEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
