...
class DeletedRequiredRoleResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.DeletedRequiredRoleEffect effect = new mir.routines.pcm2javaDepInject.DeletedRequiredRoleEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
