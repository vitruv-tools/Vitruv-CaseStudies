...
class RenamedParameterResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.RenamedParameterEffect effect = new mir.routines.pcm2javaDepInject.RenamedParameterEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
