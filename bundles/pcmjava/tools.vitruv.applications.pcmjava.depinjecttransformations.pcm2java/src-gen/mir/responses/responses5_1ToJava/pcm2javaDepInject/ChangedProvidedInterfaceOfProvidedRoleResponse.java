...
class ChangedProvidedInterfaceOfProvidedRoleResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.ChangedProvidedInterfaceOfProvidedRoleEffect effect = new mir.routines.pcm2javaDepInject.ChangedProvidedInterfaceOfProvidedRoleEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
