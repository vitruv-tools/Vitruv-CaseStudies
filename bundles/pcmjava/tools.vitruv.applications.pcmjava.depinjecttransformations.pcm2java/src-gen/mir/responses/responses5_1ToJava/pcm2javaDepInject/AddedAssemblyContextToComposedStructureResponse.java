...
class AddedAssemblyContextToComposedStructureResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.AddedAssemblyContextToComposedStructureEffect effect = new mir.routines.pcm2javaDepInject.AddedAssemblyContextToComposedStructureEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
