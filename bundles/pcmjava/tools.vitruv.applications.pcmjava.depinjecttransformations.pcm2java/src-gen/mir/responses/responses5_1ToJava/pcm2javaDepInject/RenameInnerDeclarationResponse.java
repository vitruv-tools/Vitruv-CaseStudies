...
class RenameInnerDeclarationResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.RenameInnerDeclarationEffect effect = new mir.routines.pcm2javaDepInject.RenameInnerDeclarationEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
