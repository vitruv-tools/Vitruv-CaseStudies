...
class DeletedProvidedRoleFromComponentResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.DeletedProvidedRoleFromComponentEffect effect = new mir.routines.pcm2javaDepInject.DeletedProvidedRoleFromComponentEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
