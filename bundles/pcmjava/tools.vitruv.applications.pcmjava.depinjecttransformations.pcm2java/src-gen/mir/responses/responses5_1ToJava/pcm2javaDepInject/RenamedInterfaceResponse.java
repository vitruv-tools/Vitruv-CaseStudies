...
class RenamedInterfaceResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.RenamedInterfaceEffect effect = new mir.routines.pcm2javaDepInject.RenamedInterfaceEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
