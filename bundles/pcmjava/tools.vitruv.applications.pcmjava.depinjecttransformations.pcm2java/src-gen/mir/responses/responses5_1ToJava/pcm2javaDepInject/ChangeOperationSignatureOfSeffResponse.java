...
class ChangeOperationSignatureOfSeffResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.ChangeOperationSignatureOfSeffEffect effect = new mir.routines.pcm2javaDepInject.ChangeOperationSignatureOfSeffEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
