...
class DeletedProvidedRoleFromSystemResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaDepInject.DeletedProvidedRoleFromSystemEffect effect = new mir.routines.pcm2javaDepInject.DeletedProvidedRoleFromSystemEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
