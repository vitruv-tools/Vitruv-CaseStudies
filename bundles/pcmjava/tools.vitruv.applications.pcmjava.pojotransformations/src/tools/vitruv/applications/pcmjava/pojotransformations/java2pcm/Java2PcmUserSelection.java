...
public enum Java2PcmUserSelection {
	SELECT_BASIC_COMPONENT(0, "create Basic Component"), SELECT_COMPOSITE_COMPONENT(1, "create Composite Component"),
	SELECT_SYSTEM(2, "create System"), SELECT_COMPOSITE_DATA_TYPE(0, "create composite Data Type"),
