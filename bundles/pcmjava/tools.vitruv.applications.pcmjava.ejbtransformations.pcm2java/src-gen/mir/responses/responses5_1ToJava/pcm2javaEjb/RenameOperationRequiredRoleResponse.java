...
class RenameOperationRequiredRoleResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.RenameOperationRequiredRoleEffect effect = new mir.routines.pcm2javaEjb.RenameOperationRequiredRoleEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
