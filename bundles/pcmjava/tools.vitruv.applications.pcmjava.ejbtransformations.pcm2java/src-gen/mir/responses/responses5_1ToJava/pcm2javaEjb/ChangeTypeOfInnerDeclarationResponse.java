...
class ChangeTypeOfInnerDeclarationResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.ChangeTypeOfInnerDeclarationEffect effect = new mir.routines.pcm2javaEjb.ChangeTypeOfInnerDeclarationEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
