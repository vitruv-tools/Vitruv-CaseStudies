...
class ChangeOperationRequiredRoleInterfaceResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.ChangeOperationRequiredRoleInterfaceEffect effect = new mir.routines.pcm2javaEjb.ChangeOperationRequiredRoleInterfaceEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
