...
class ChangeOperationSignatureReturnTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.ChangeOperationSignatureReturnTypeEffect effect = new mir.routines.pcm2javaEjb.ChangeOperationSignatureReturnTypeEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
