...
class RenameOperationSignatureResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.RenameOperationSignatureEffect effect = new mir.routines.pcm2javaEjb.RenameOperationSignatureEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
