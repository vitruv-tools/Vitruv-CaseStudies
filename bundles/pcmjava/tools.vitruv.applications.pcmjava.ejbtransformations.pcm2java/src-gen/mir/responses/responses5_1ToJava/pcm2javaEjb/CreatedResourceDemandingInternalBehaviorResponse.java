...
class CreatedResourceDemandingInternalBehaviorResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.CreatedResourceDemandingInternalBehaviorEffect effect = new mir.routines.pcm2javaEjb.CreatedResourceDemandingInternalBehaviorEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
