...
class DeletedProvidedRoleFromSystemResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.DeletedProvidedRoleFromSystemEffect effect = new mir.routines.pcm2javaEjb.DeletedProvidedRoleFromSystemEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
