...
class RenamedCollectionDataTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.RenamedCollectionDataTypeEffect effect = new mir.routines.pcm2javaEjb.RenamedCollectionDataTypeEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
