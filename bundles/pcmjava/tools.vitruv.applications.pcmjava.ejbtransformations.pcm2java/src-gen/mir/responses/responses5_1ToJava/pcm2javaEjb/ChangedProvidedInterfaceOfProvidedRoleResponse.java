...
class ChangedProvidedInterfaceOfProvidedRoleResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.ChangedProvidedInterfaceOfProvidedRoleEffect effect = new mir.routines.pcm2javaEjb.ChangedProvidedInterfaceOfProvidedRoleEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
