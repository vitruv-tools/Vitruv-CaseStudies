...
class ChangeOperationSignatureOfSeffResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.ChangeOperationSignatureOfSeffEffect effect = new mir.routines.pcm2javaEjb.ChangeOperationSignatureOfSeffEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
