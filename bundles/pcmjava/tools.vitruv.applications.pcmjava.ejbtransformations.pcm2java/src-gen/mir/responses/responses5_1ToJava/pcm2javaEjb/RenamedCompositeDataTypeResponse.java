...
class RenamedCompositeDataTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.RenamedCompositeDataTypeEffect effect = new mir.routines.pcm2javaEjb.RenamedCompositeDataTypeEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
