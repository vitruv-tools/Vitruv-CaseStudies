...
class ChangeOperationRequiredRoleEntityResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.ChangeOperationRequiredRoleEntityEffect effect = new mir.routines.pcm2javaEjb.ChangeOperationRequiredRoleEntityEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
