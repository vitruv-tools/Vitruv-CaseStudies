...
class DeletedProvidedRoleFromComponentResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.DeletedProvidedRoleFromComponentEffect effect = new mir.routines.pcm2javaEjb.DeletedProvidedRoleFromComponentEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
