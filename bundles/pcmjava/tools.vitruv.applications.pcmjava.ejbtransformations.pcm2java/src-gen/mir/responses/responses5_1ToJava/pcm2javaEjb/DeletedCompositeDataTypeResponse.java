...
class DeletedCompositeDataTypeResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.DeletedCompositeDataTypeEffect effect = new mir.routines.pcm2javaEjb.DeletedCompositeDataTypeEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
