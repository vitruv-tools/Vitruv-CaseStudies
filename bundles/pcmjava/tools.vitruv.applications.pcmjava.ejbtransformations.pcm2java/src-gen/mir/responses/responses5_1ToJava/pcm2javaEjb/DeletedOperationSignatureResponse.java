...
class DeletedOperationSignatureResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.DeletedOperationSignatureEffect effect = new mir.routines.pcm2javaEjb.DeletedOperationSignatureEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
