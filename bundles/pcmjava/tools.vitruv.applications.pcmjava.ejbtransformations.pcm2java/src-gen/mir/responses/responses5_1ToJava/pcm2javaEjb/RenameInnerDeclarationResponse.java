...
class RenameInnerDeclarationResponse extends AbstractResponseRealization {
  ...
  public void executeResponse(final EChange change) {
    ...
    mir.routines.pcm2javaEjb.RenameInnerDeclarationEffect effect = new mir.routines.pcm2javaEjb.RenameInnerDeclarationEffect(this.executionState, this, typedChange);
    effect.applyRoutine();
  }
}
