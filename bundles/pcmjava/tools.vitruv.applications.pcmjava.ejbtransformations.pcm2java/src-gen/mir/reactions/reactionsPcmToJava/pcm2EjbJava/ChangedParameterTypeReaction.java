...
class ChangedParameterTypeReaction extends AbstractReactionRealization {
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsPcmToJava.pcm2EjbJava.ChangedParameterTypeReaction.ActionUserExecution userExecution = new mir.reactions.reactionsPcmToJava.pcm2EjbJava.ChangedParameterTypeReaction.ActionUserExecution(this.executionState, this);
