...
class RenamedRepositoryReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2ejbJava.RenamedRepositoryReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2ejbJava.RenamedRepositoryReaction.ActionUserExecution(this.executionState, this);
