...
class DeletedDemandingInternalBehaviorReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2ejbJava.DeletedDemandingInternalBehaviorReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2ejbJava.DeletedDemandingInternalBehaviorReaction.ActionUserExecution(this.executionState, this);
