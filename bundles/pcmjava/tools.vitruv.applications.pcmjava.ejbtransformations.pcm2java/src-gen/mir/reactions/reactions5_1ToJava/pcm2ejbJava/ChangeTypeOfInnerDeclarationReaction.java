...
class ChangeTypeOfInnerDeclarationReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2ejbJava.ChangeTypeOfInnerDeclarationReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2ejbJava.ChangeTypeOfInnerDeclarationReaction.ActionUserExecution(this.executionState, this);
