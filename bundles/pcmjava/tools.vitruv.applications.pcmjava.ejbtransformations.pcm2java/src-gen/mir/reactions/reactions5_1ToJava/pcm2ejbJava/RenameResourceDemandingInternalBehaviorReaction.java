...
class RenameResourceDemandingInternalBehaviorReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2ejbJava.RenameResourceDemandingInternalBehaviorReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2ejbJava.RenameResourceDemandingInternalBehaviorReaction.ActionUserExecution(this.executionState, this);
