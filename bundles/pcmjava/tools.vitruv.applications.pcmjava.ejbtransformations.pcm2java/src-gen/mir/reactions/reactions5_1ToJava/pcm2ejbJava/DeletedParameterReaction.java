...
class DeletedParameterReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactions5_1ToJava.pcm2ejbJava.DeletedParameterReaction.ActionUserExecution userExecution = new mir.reactions.reactions5_1ToJava.pcm2ejbJava.DeletedParameterReaction.ActionUserExecution(this.executionState, this);
