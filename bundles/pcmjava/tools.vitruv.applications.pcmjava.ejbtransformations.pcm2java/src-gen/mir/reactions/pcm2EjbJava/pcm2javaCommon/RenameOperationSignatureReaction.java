...
public class RenameOperationSignatureReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2EjbJava.pcm2javaCommon.RenameOperationSignatureReaction.ActionUserExecution userExecution = new mir.reactions.pcm2EjbJava.pcm2javaCommon.RenameOperationSignatureReaction.ActionUserExecution(this.executionState, this);
