...
public class ExecutorJavaToPcm extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(mir.reactions.reactionsJavaToPcm.java2pcm.PackageCreatedReaction.getExpectedChangeType(), new mir.reactions.reactionsJavaToPcm.java2pcm.PackageCreatedReaction(userInteracting));
