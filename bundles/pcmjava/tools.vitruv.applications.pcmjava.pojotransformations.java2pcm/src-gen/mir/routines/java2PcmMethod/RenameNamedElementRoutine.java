...
public class RenameNamedElementRoutine extends AbstractRepairRoutineRealization {
  ...
  public RenameNamedElementRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final NamedElement javaElement) {
