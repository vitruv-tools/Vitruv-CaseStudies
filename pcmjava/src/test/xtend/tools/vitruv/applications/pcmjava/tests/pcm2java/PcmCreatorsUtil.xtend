...
class PcmCreatorsUtil {
	...
	static def createOperationProvidedRole(OperationInterface providedInterface,
		InterfaceProvidingEntity providingEntity) {
	...
	static def createOperationRequiredRole(OperationInterface providedInterface,
		InterfaceRequiringEntity requiringEntity) {
